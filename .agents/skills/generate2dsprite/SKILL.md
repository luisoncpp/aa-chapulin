...
- Follow [references/asset-sanitization.md](references/asset-sanitization.md) for post-processing chroma keying, mathematical contour despill, interior cavity extraction, skin preservation, and custom crop bounds for extended gestures.
- Never allow unkeyed solid magenta pockets, antialiased purple outline fringe, clipped outstretched extremities, or erased fair skin areas into production assets. Always verify with automated pixel-level quality gates before accepting.
...
- `references/asset-sanitization.md`: chroma keying, mathematical contour despill, cavity extraction, skin preservation, and clipping avoidance
