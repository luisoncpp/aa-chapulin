...
| [[docs/flows/save-load-flow.md\|save-load-flow.md]] | Save & Load Persistence | Player clicks Save (💾), Load (📂), or Continue on splash screen. | [[src/state/Private/SaveManager.ts]], [[src/engine/Private/GameEngine.ts]], [[src/state/Private/GameStateManager.ts]] |
| [[docs/flows/present-point-flow.md\|present-point-flow.md]] | Present & Point (Case 4) | Correct present on a statement/follow-up/stage with `pointTarget`; player clicks a zone on the 640×360 plate. | [[src/engine/Private/PresentPoint.ts]], [[src/engine/Private/TrialPresent.ts]] |
| [[docs/flows/character-record-flow.md\|character-record-flow.md]] | Acta de Personajes (Case 1) | Player opens the Court Record in a case with profiles, or the court demands a person. | [[src/engine/Private/CourtRecordTabs.ts]], [[src/engine/Private/ProfilePresent.ts]], [[src/state/Private/ProfileInventory.ts]] |
| [[docs/flows/evidence-examine-flow.md\|evidence-examine-flow.md]] | Court Record Deep Examine (Case 4) | Player selects evidence with `detailedView` and clicks Examinar Detalle in the Acta. | [[src/engine/Private/EvidenceExamine.ts]], [[src/engine/Private/ModalManager.ts]] |
| [[docs/flows/music-player-flow.md\|music-player-flow.md]] | Title-Screen Soundtrack Jukebox | Player opens the ♫ overlay on the start splash, previews tracks, or closes it before starting a case. | [[src/engine/Private/MusicPlayer/index.ts]], [[src/audio/index.ts#listSoundtrack]] |
