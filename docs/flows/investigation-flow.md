...
## 4. Reads
- Active `script.investigation[location]` ([[src/case/case1/Private/museo.ts]] or Case 2 scenes via [[src/case/case2/index.ts]])
...
- [[src/case/case1/Private/museo.ts]] / [[src/case/case2/index.ts]]
