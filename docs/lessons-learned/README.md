...
| [`reused-backgrounds-do-not-grow-props.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/reused-backgrounds-do-not-grow-props.md) | Reused investigation plates only offer the props they already paint; Case 5 hotspots follow the vault door and paper tray, not the spec’s missing door and ribbon files. | 2026-09-18 |
