...
| [`present-point-cover-crop.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/present-point-cover-crop.md) | Present & Point bounds are percent of the contained examine plate, not the raw JPEG. | 2026-09-04 |
...
| [`present-point-cover-crop.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/present-point-cover-crop.md) | Present & Point zone bounds are % of the contained examine plate, not raw JPEG pixels. | 2026-09-04 |
...
| [`location-cast-rotation.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/location-cast-rotation.md) | Rotating hotel residents uses new location ids (`_d2` / `_d3`), not in-place cast swaps. | 2026-09-04 |
| [`shared-evidence-id-filenames.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/shared-evidence-id-filenames.md) | Shared `EvidenceId` values still collide on `assets/<id>.webp` unless the later case overrides `icon`. | 2026-09-04 |
