...
| [`tracker-meter-is-a-free-parameter.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/tracker-meter-is-a-free-parameter.md) | The sequencer has no bars, so 5/4 and 9/8 tracks are free; implying an odd meter from inside 4/4 does not work. | 2026-09-17 |
