...
| [`court-record-unlabeled-icon-grid.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/court-record-unlabeled-icon-grid.md) | Image-only icon sheets need separator removal without dropping the lower 20% of artwork. | 2026-09-05 |
...
| [`investigation-scene-intro-lifecycle.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/investigation-scene-intro-lifecycle.md) | Scene entrance dialogues are governed by intro flags, enabling event-driven re-visits without boolean location sets. | 2026-09-03 |
| [`scene-revisit-idle-pose-resolution.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/scene-revisit-idle-pose-resolution.md) | Resident character staging on re-visits and dialogue completions resolves from semantic `idlePose`, preventing player sprite retention. | 2026-09-03 |
| [`present-point-cover-crop.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/present-point-cover-crop.md) | Overlay Present & Point boxes on the generated 960×540 WebP; spec guesses miss the painted object. | 2026-09-04 |
| [`location-cast-rotation.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/location-cast-rotation.md) | Replacing a scene resident uses a new `_d2`/`_d3` location id, not a mutated scene object. | 2026-09-04 |
| [`shared-evidence-id-filenames.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/shared-evidence-id-filenames.md) | Shared `EvidenceId` values still collide on `assets/<id>.webp` unless the later case overrides `icon`. | 2026-09-04 |
| [`present-point-overlay-yields-to-dialogue.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/present-point-overlay-yields-to-dialogue.md) | Hide the point overlay during fail/success dialogue or the modal blocks advance; reopen after a miss. | 2026-09-04 |
| [`climax-final-stage-success-then-verdict.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/climax-final-stage-success-then-verdict.md) | A no-choice final climax stage must play `successDialogue` before `verdict`; Case 1 has no `stages` so verdict-only. | 2026-09-04 |
| [`en-scene-spread-inherits-spanish.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/en-scene-spread-inherits-spanish.md) | Spreading a Spanish scene or point target into an `_en` module leaks Spanish text past types, tests and lint. | 2026-09-05 |
| [`investigation-gating-and-evidence-stages.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/investigation-gating-and-evidence-stages.md) | Scene intros don't recheck trial readiness; the two `unlockedBy*` fields are OR; evidence stages are a linear counter that silently drops extra updates. | 2026-09-05 |
| [`court-record-icon-matches-examine.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/court-record-icon-matches-examine.md) | Polaroid icon rewrites invent a second scene unless the examine plate is the identity lock. | 2026-09-05 |
| [`contradiction-followup-plays-twice.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/contradiction-followup-plays-twice.md) | A contradiction and its `followUp` each queue a dialogue; aliasing both to one array replays it. | 2026-09-05 |
| [`examine-zones-are-native-buttons.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/examine-zones-are-native-buttons.md) | Overlay hitboxes built from `<button>` paint white unless native chrome is reset; measure zones on the plate. | 2026-09-05 |
| [`climax-bgm-line-override.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/climax-bgm-line-override.md) | The first climax dialogue line’s `bgm` overrides the engine’s `suspense` opener for the whole build-up. | 2026-09-05 |
| [`examine-prompt-no-chirp.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/examine-prompt-no-chirp.md) | The persistent examine instruction is UI text and must bypass typewriter chirps. | 2026-09-05 |
| [`climax-stage-prompt-spoils-answer.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/climax-stage-prompt-spoils-answer.md) | `stage.prompt` is asked before the present; naming the target evidence spoils the reveal. | 2026-09-05 |
| [`visual-log-times-follow-canonical-timeline.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/visual-log-times-follow-canonical-timeline.md) | Timestamped evidence plates must be checked against the canonical case timeline, not only script text. | 2026-09-05 |
| [`case0-script-visual-contract.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/case0-script-visual-contract.md) | Tutorial labels must preserve the current shot; every visible Case 0 line needs an explicit pose and every point miss needs coaching. | 2026-09-09 |
| [`static-dist-build-staleness.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/static-dist-build-staleness.md) | Vitest source execution does not refresh the static `dist/` application. | 2026-09-10 |
| [`launch-splash-and-scene-fades.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/launch-splash-and-scene-fades.md) | The launch splash already supplies the fade; direct case starts must not stack a second scene fade. | 2026-09-11 |
| [`conditional-acta-tab-bar.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/conditional-acta-tab-bar.md) | A new Acta tab, a substitute schema field, and a save-version bump each reach back into the cases that already shipped. | 2026-09-13 |
| [`court-record-escape-recovery.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/court-record-escape-recovery.md) | Modal keyboard guards need an Escape exit so reading PERSONAS cannot look like a frozen trial. | 2026-09-13 |
| [`investigation-hotspot-targets-must-be-on-background.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/investigation-hotspot-targets-must-be-on-background.md) | Examine mode hides sprites, so clickable clue targets must be painted into the scene background. | 2026-09-13 |
| [`case-spec-fact-ledger.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/case-spec-fact-ledger.md) | Review passes on a long case spec track the lens you gave them, not its quality; a fact ledger with agent and scale columns converges where repeated audits do not. | 2026-09-13 |
| [`present-point-court-record-consult.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/present-point-court-record-consult.md) | Equal modal layers require pausing the point overlay, while presentation gating must track active state rather than visibility. | 2026-09-15 |
| [`bgm-aliases-preserve-sequencer-position.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/bgm-aliases-preserve-sequencer-position.md) | Narrative BGM aliases must compare their shared composition before restarting the sequencer. | 2026-09-16 |
| [`bgm-seek-is-sequencer-step.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/bgm-seek-is-sequencer-step.md) | Jukebox seek/scrub maps to `MidiMusicComposer` step index, not AudioBuffer time. | 2026-09-17 |
| [`ledger-columns-follow-case-risk.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/ledger-columns-follow-case-risk.md) | A reused fact ledger must add columns for the new mystery's actual failure modes. | 2026-09-16 |
| [`spec-audit-lens-log.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/spec-audit-lens-log.md) | Case-spec audits converge only with a lens log, simulation passes, and relational tests instead of string tests. | 2026-09-17 |
| [`court-record-detail-occludes-stage.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/court-record-detail-occludes-stage.md) | Court Record detail plates must hide the underlying stage character and restore its previous visibility on close. | 2026-09-16 |
| [`court-role-penalty-after-recusal.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/court-role-penalty-after-recusal.md) | Leftover Super Sam sprite and hardcoded penalty prosecutor after recusal; `berrondo_idle` identity lock. | 2026-09-21 |
| [`press-hint-follows-counsel.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/press-hint-follows-counsel.md) | Press hint speaker must match who is counsel; default Chapulín line names Don Ramón. | 2026-09-21 |
| [`witness-deflect-not-prosecutor.md`](file:///c:/Proyectos/ace-attorney-gemini/docs/lessons-learned/witness-deflect-not-prosecutor.md) | A witness who can deny a document needs a scripted deflect; sweat is the catch, not the denial. | 2026-09-21 |
