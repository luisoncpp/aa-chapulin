...
| **Sargento Pazguato** | Case 3 Gumshoe-style cop: contaminates the scene, then recovers the station-cut cartridge from the trash. | [[src/case/case3/index.ts]] |
| **Don Aniceto Rebollar** | Case 3 star announcer and true culprit; corrects other people's diction and cannot let a misquoted sketch line pass. | [[src/case/case3/index.ts]] |
