...
- [ ] `NO CONTRADECIR` — «Trece años» describe su antigüedad declarada en estrado, no la edad de la persona ni un número que deba aparecer en el retrato (§17.2; `docs/specs/case-5-el-tomo-trece.md:3111-3115`; `src/case/case5/Private/trial_day4_success.ts:47-51`; EN `_en.ts:46-50`).
...
- [ ] `NO CONTRADECIR` — En D4-T1, Genoveva es llamada como encargada de la ventanilla y se presenta con `genoveva_idle`; la pose del perfil debe conservar esa identidad visual (`docs/specs/case-5-el-tomo-trece.md:3111-3115`; `src/case/case5/Private/trial_day4_success.ts:47-50`; EN `_en.ts:46-49`).
