...
export const CLIMAX_DATA: ClimaxDefinition = {
  dialogue: [
    ...
    { speaker: 'DEFENSA', text: '(Es mi última oportunidad. Las Antenitas de Vinil están detectando la presencia del enemigo... ¡justo en el estrado del testigo!)', pose: 'chapulin_idle' }
  ],
  presentTarget: ['antenitas_vinil', 'bolsa_dolares'],
  // @Section(Guilty Confession & Not Guilty Verdict)
  verdict: [
    { cutin: 'objection_protesto', speaker: 'DEFENSA', text: '¡PROTESTO!', sfx: 'whoosh', bgm: 'pursuit', pose: 'chapulin_point' },
    ...
    { speaker: 'DEFENSA', text: '¡Oficial, revise el forro de la chaqueta del testigo!', sfx: 'realization', pose: 'chapulin_point' },
    ...
    { speaker: 'DEFENSA', text: '¡Caso Cerrado!', pose: 'chapulin_idle' }
  ]
};
