  ...
  statements: [
    {
      ...
      pressText: [
        { speaker: 'DEFENSA', text: '¡UN MOMENTO!', cutin: 'objection_un_momento', sfx: 'whoosh', pose: 'chapulin_point' },
        { speaker: 'DEFENSA', text: '¿En qué restaurante exactamente estaba cenando, señor Tripaseca?', pose: 'chapulin_idle' },
    ...
    },
    {
      ...
      pressText: [
        { speaker: 'DEFENSA', text: '¡UN MOMENTO!', cutin: 'objection_un_momento', sfx: 'whoosh', pose: 'chapulin_point' },
        { speaker: 'DEFENSA', text: '¿Dice que vio el impacto claramente?', pose: 'chapulin_idle' },
      ...
      contradiction: {
        ...
        successDialogue: [
          { cutin: 'objection_protesto', speaker: 'DEFENSA', text: '¡PROTESTO!', sfx: 'whoosh', bgm: 'objection', pose: 'chapulin_point' },
          ...
          { speaker: 'DEFENSA', text: "¡Observe detenidamente el 'Chipote Chillón'! ¡Es de vinil blando y hueco! Al golpear hace esto...", sfx: 'chipote', pose: 'chapulin_idle' },
          { speaker: 'JUEZ', text: '¡Vaya sonido tan simpático! Me recuerda a los juguetes de mi nieto.', pose: 'judge_thinking' },
          { speaker: 'DEFENSA', text: '¡El Informe Médico demuestra que Alma Negra sufrió un traumatismo por un impacto con MONEDAS METÁLICAS DENSAS!', sfx: 'realization', pose: 'chapulin_slam' },
    ...
    },
    {
      ...
      pressText: [
        { speaker: 'DEFENSA', text: '¡UN MOMENTO!', cutin: 'objection_un_momento', sfx: 'whoosh', pose: 'chapulin_point' },
        { speaker: 'DEFENSA', text: '¿No había un sistema de alarma en la vitrina?', pose: 'chapulin_idle' },
  ...
  statements: [
    {
      ...
      pressText: [
        { speaker: 'DEFENSA', text: '¡UN MOMENTO!', cutin: 'objection_un_momento', sfx: 'whoosh', pose: 'chapulin_point' },
        { speaker: 'DEFENSA', text: 'La puerta principal estaba cerrada con llave según el registro policial.', pose: 'chapulin_idle' },
      ...
      contradiction: {
        ...
        successDialogue: [
          ...
          { speaker: 'DEFENSA', text: "¡En el suelo de la vitrina encontramos restos de 'Pastillas de Chiquitolina' junto al ducto de ventilación!", sfx: 'realization', pose: 'chapulin_idle' },
    ...
    },
    {
      ...
      pressText: [
        { speaker: 'DEFENSA', text: '¡UN MOMENTO!', cutin: 'objection_un_momento', sfx: 'whoosh', pose: 'chapulin_point' },
        { speaker: 'DEFENSA', text: '¿Está seguro de la dirección en la que corría el sospechoso?', pose: 'chapulin_idle' },
      ...
      contradiction: {
        ...
        successDialogue: [
          { cutin: 'objection_toma_eso', speaker: 'DEFENSA', text: '¡TOMA ESO!', sfx: 'whoosh', bgm: 'pursuit', pose: 'chapulin_point' },
          ...
          { speaker: 'DEFENSA', text: '¡La cámara no fotografió directamente al sujeto! Capturó su reflejo en el gran espejo veneciano del pasillo.', sfx: 'realization', pose: 'chapulin_idle' },
