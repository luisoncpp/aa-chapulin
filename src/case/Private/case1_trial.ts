...
export const TRIAL_INTRO: DialogueLine[] = [
  ...
  { bg: 'assets/bg_courtroom.jpg', speaker: 'DEFENSA', pose: 'chapulin_slam', text: '¡La defensa está lista, Su Señoría! ¡Y demostraremos la inocencia del Chapulín Colorado!', sfx: 'desk_slam' },
