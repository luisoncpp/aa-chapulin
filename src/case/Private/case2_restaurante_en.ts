...
export const CASE2_RESTAURANTE_EN: InvestigationScene = {
  ...
  hotspots: [
    ...
    },
    {
      ...
      x: 69, y: 30, w: 13, h: 28,
      dialogue: [
        { speaker: 'DEFENSA', text: 'Look! The crowbar tip has navy-blue generator paint...', pose: 'donramon_slam', sfx: 'realization', updateEvidence: 'palanca_rota' },
        { speaker: 'DEFENSA', text: 'They used it to force the generator box, not the safe!', pose: 'donramon_slam', addEvidence: 'caja_generador' }
      ]
    }
  ],
  talkOptions: [
