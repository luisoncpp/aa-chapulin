...
export const CASE0_TRIAL_INTRO_EN: DialogueLine[] = [
  ...
  { speaker: 'SUPER SAM', pose: 'supersam_idle', text: 'Your Honor, I solved this case in eleven minutes. ELEVEN! A boy behind on rent, a collector on the floor, and a briefcase gone. Time is money.' },
  ...
  { speaker: 'DEFENSA', pose: 'donramon_idle', text: '(Fourteen months of back rent, Monchito. Win this and we eat.)' },
...
export const CASE0_TESTIMONY_1_EN: Testimony = {
  title: 'Testimony: What I saw from the courtyard', witness: 'Casimiro Lengua', bgm: 'cross_exam_moderato', statements: [
    ...
    { id: 'c0_t1_3', speaker: 'CASIMIRO', pose: 'casimiro_amable', text: 'I looked into the courtyard and saw the defendant run out with the collector’s briefcase in his hand.', pressText: [
      { speaker: 'DEFENSA', pose: 'donramon_point', cutin: 'objection_un_momento', sfx: 'whoosh', text: 'HOLD IT!' },
      { speaker: 'CASIMIRO', pose: 'casimiro_sweat', text: 'Run out, yes; the briefcase... I saw it from the corner of my eye.' }
    ], contradiction: {
      evidence: ['parte_detencion'],
      successDialogue: [
        { speaker: 'DEFENSA', pose: 'donramon_slam', cutin: 'objection_protesto', sfx: 'desk_slam', text: 'OBJECTION! That briefcase appears nowhere in this report!', bgm: 'objection' },
        { speaker: 'DEFENSA', pose: 'donramon_point', text: 'The report says my client had an ice bar, forty cents, and an ice-shop receipt at 2:15. No rent briefcase.' },
        { speaker: 'CASIMIRO', pose: 'casimiro_sweat', text: 'One says “with the briefcase” as a figure of speech. Synecdoche, if you please.' },
      ...
      followUp: {
        evidence: ['recibo_hielo'], prompt: 'Where was the defendant at one o’clock?', successDialogue: [
          ...
          { speaker: 'CHAPULÍN', pose: 'chapulin_point', text: 'There it is, Monchito. We have just been given the second testimony.' }
        ]
      }
    }},
...
const CASE0_T2_BELL_CONTRADICTION_EN: ContradictionRule = {
  evidence: ['foto_patio'], requiresExamine: 'foto_patio', pointTarget: CASE0_FOTO_POINT_TARGET_EN,
    ...
    { speaker: 'SUPER SAM', pose: 'supersam_slam', cutin: 'objection_un_momento', sfx: 'desk_slam', text: 'HOLD IT! If he did not hear the blow at one, how did he know the collector had a briefcase?' },
...
export const CASE0_TESTIMONY_3_EN: Testimony = {
  title: 'Testimony: How that briefcase reached my portfolio', witness: 'Casimiro Lengua', bgm: 'cross_exam_presto', statements: [
    { id: 'c0_t3_1', speaker: 'CASIMIRO', pose: 'casimiro_amable', text: 'I stole nothing, Your Honor. I found that briefcase lying in the neighborhood alley.', pressText: [
      { speaker: 'DEFENSA', pose: 'donramon_point', cutin: 'objection_un_momento', sfx: 'whoosh', text: 'HOLD IT!' },
    ...
    { id: 'c0_t3_2', speaker: 'CASIMIRO', pose: 'casimiro_catalogo', text: 'I picked it up at twenty to three, after the patrol had taken the boy away.', pressText: [
      ...
      evidence: ['parte_detencion'], successDialogue: [
        { speaker: 'DEFENSA', pose: 'donramon_slam', cutin: 'objection_protesto', sfx: 'desk_slam', text: 'OBJECTION! You described that briefcase twenty-five minutes before you found it!', bgm: 'objection' },
        ...
        { speaker: 'CASIMIRO', pose: 'casimiro_sweat', text: 'I inferred it. A collector always carries a briefcase. Logical inference.' },
        { speaker: 'SUPER SAM', pose: 'supersam_slam', sfx: 'desk_slam', text: 'That agent is MY agent and writes like an angel!' },
        { speaker: 'JUEZ', pose: 'judge_shock', text: 'You saw the briefcase, or described it without seeing it. Choose.' }
      ], followUp: {
        evidence: ['tarjeta_enciclopedias'], prompt: 'What does the witness\'s occupation say about his presence in the neighborhood?', successDialogue: [
          ...
          { speaker: 'CHAPULÍN', pose: 'chapulin_point', text: 'No one counted on the briefcase carrying a tutorial for catching culprits!' }
        ]
      }
    }},
    { id: 'c0_t3_3', speaker: 'CASIMIRO', pose: 'casimiro_amable', text: 'I never opened it. I would have turned it in at the precinct after my workday.', pressText: [
      { speaker: 'DEFENSA', pose: 'donramon_point', cutin: 'objection_un_momento', sfx: 'whoosh', text: 'HOLD IT!' },
      { speaker: 'CASIMIRO', pose: 'casimiro_sweat', text: 'It was empty anyway. I could feel how light it was.' }
    ] },
...
export const CASE0_OPENING_PRESENT_EN: OpeningPresent = {
  ...
  successDialogue: [
    ...
    { speaker: 'CHAPULÍN', pose: 'chapulin_point', text: 'One more thing, Monchito: before presenting the Courtyard Photo, select it in the COURT RECORD and click EXAMINE DETAIL to view it up close.' },
    { speaker: 'EXAMINE MODE', text: 'Do this before presenting the photo: the enlarged view will help you find the correct detail.', instant: true },
