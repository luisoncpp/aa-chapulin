...
export const CASE0_LOBBY_INTRO: DialogueLine[] = [
  ...
  { bg: WAITING_ROOM, furniture: 'none', speaker: 'TORIBIO', pose: 'toribio_llorando', text: '¡Licenciado! ¡Licenciado Monchito! ¡Por su madrecita santa, dígame la verdad! ¿Me van a mandar a las Islas Marías?' },
  { bg: WAITING_ROOM, furniture: 'none', speaker: 'DEFENSA', pose: 'donramon_idle', text: '¡Cálmate, Toribio, cálmate! ¡No te me achicopales antes de tiempo! Con el Licenciado Monchito en la defensa estás en las mejores manos...' },
  ...
  { bg: WAITING_ROOM, furniture: 'none', speaker: 'CHAPULIN', pose: 'chapulin_idle', text: '¡Tranquilo, Monchito! La clave de un juicio es simple: el testigo del fiscal va a soltar su versión. Tú debes escuchar cada frase con calma.' },
...
export const CASE0_T2_RECESS_AND_RESUMPTION: DialogueLine[] = [
  ...
  { bg: WAITING_ROOM, furniture: 'none', speaker: 'TORIBIO', pose: 'toribio_aliviado', text: '¡Licenciado Monchito! ¡Estuvo colosal! ¡Le dio hasta por debajo de la lengua al señor de las enciclopedias!' },
  ...
  { bg: WAITING_ROOM, furniture: 'none', speaker: 'CHAPULIN', pose: 'chapulin_point', text: '¡Oye, Monchito! Antes de que se nos acaben los veinte minutos del receso... ¿ya te aseguraste de tener todo en orden?' },
  ...
  { speaker: 'NARRADOR', text: 'Tres tomos con el lomo roto, una tarjeta de presentación y un maletín de cobranza vacío.', addEvidence: 'maletin_cobranza' },
  ...
  { speaker: 'JUEZ', pose: 'judge_neutral', text: 'Señor Lengua, va a explicar a esta corte cómo llegó ese maletín a su portafolio. Y le advierto que ahora cada palabra suya se asienta en su contra.' },
  { speaker: 'CHAPULIN', pose: 'chapulin_point', text: '¡Y ahora sí, Monchito, el testigo va a testificar de su propio caso!' },
