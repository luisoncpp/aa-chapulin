...
export const CASE0_LOBBY_INTRO_EN: DialogueLine[] = [
  ...
  { bg: WAITING_ROOM, furniture: 'none', speaker: 'CHAPULIN', pose: 'chapulin_idle', text: 'Relax, Don Ramón! A trial is simple. The prosecutor’s witness will tell his story. Listen carefully to every sentence.' },
...
export const CASE0_T2_RECESS_AND_RESUMPTION_EN: DialogueLine[] = [
  ...
  { bg: WAITING_ROOM, furniture: 'none', speaker: 'TORIBIO', pose: 'toribio_aliviado', text: 'Counselor Don Ramón! You were magnificent! You got that encyclopedia man right under his tongue!' },
  ...
  { bg: WAITING_ROOM, furniture: 'none', speaker: 'CHAPULIN', pose: 'chapulin_point', text: 'Don Ramón! Before the recess ends... did you make sure everything is in order?' },
