...
export const CASE1_CAMARAS: InvestigationScene = {
  ...
  intro: [
    { speaker: 'NARRADOR', text: '23 de agosto, 11:00 AM. Pasillo que une el vestíbulo con la puerta de carga. En el muro largo, un espejo veneciano de tres metros.', bg: 'assets/bg_pasillo_espejo.webp', furniture: 'none', bgm: 'suspense' },
    ...
    { speaker: 'CHAPULIN', text: '¡Qué espejo tan grande! ¡Se ve todo el pasillo!', pose: 'chapulin_point' },
    { speaker: 'DEFENSA', text: '(Se ve todo el pasillo. Sí. Se ve todo el pasillo.)', pose: 'donramon_idle' }
  ],
  hotspots: [
    {
      id: 'hotspot_camara',
      ...
      x: 4, y: 3, w: 13, h: 20,
      dialogue: [
        { speaker: 'NARRADOR', text: 'Una caja metálica atornillada en lo alto del muro del vestíbulo, apuntando hacia el pasillo.' },
        ...
        { speaker: 'FLORINDA', text: 'Además sólo pega si cruza la luz del fondo. A oscuras, en este pasillo, no retrata ni un elefante.', pose: 'florinda_angry' },
        { speaker: 'DEFENSA', text: '(O sea que lo que dispara esa cámara es lo que se mueve contra la puerta de carga. Lo demás, para ella, no existe.)', pose: 'donramon_idle' },
        { speaker: 'DEFENSA', text: '(Está atornillada mirando hacia acá... o sea, mirando al espejo.)', pose: 'donramon_shock' },
    ...
    },
    {
      ...
      x: 72, y: 0, w: 28, h: 90,
      dialogue: [
        { speaker: 'NARRADOR', text: 'Tres metros de cristal antiguo con marco tallado. Refleja el pasillo entero, de punta a punta.' },
        { speaker: 'DEFENSA', text: 'Doña Florinda, ¿qué se ve en este espejo desde donde está la cámara?', pose: 'donramon_idle' },
        { speaker: 'FLORINDA', text: 'Pues el pasillo. Desde el vestíbulo hasta la puerta de carga.', pose: 'florinda_idle' },
        { speaker: 'DEFENSA', text: '¿La puerta de carga se ve en el espejo?', pose: 'donramon_shock' },
        { speaker: 'FLORINDA', text: 'Se ve entera. Por eso me molesta: se me ve el tiradero del patio desde la entrada bonita.', pose: 'florinda_angry' },
        { speaker: 'CHAPULIN', text: '¡Licenciado! ¡Si la cámara ve el espejo, y el espejo ve la puerta de carga...!', pose: 'chapulin_point' },
        { speaker: 'DEFENSA', text: '...entonces esa cámara nunca fotografió el vestíbulo.', pose: 'donramon_shock' },
        { speaker: 'DEFENSA', text: '(Y todo lo que salga en esa foto está al revés.)', pose: 'donramon_idle' },
        { speaker: 'CHAPULIN', text: '¡Al revés! ¡Como cuando uno se peina frente al espejo y se hace la raya del lado equivocado!', pose: 'chapulin_idle' },
        { speaker: 'DEFENSA', text: 'Igualito, joven. Guárdeselo para el juicio.', pose: 'donramon_point', unlockLocation: 'clinica_d2' }
      ]
    }
  ],
  talkOptions: []
