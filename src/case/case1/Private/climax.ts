...
const STAGE_4_SUCCESS: DialogueLine[] = [
  ...
  { bg: 'assets/examine_ficha_museo.webp', furniture: 'none', speaker: 'NARRADOR', text: 'Tarjeta de cartulina, mecanografiada, del tamaño de una ficha de biblioteca.' },
  { bg: 'assets/examine_ficha_museo.webp', furniture: 'none', speaker: 'NARRADOR', text: '"Uno. Chapa puerta de carga: vencida desde marzo. Se empuja."' },
  { bg: 'assets/examine_ficha_museo.webp', furniture: 'none', speaker: 'NARRADOR', text: '"Dos. Rejilla sala 2: 18 × 24. Malla floja en la esquina inferior. Da al patio."' },
  { bg: 'assets/examine_ficha_museo.webp', furniture: 'none', speaker: 'NARRADOR', text: '"Tres. Velador: 20:45 bodega de proa. 21:00 bodega de popa. Copiado de su libreta; cuelga de un clavo en la caseta."' },
  { bg: 'assets/examine_ficha_museo.webp', furniture: 'none', speaker: 'NARRADOR', text: '"Cuatro. Pastillas de chiquitolina: farmacia de Insurgentes, mostrador de atrás."' },
  { bg: 'assets/examine_ficha_museo.webp', furniture: 'none', speaker: 'NARRADOR', text: '"Cinco. Rollo de cámara: se cambia los lunes. El martes queda un cuadro."' },
  { bg: 'assets/examine_ficha_museo.webp', furniture: 'none', speaker: 'NARRADOR', text: '"Seis. Servicio de cierre incluido. 5 min."' },
  { bg: 'assets/examine_ficha_museo.webp', furniture: 'none', speaker: 'NARRADOR', text: 'Al reverso, un membrete impreso: "Enciclopedias El Saber Universal, S. A."' },
  { bg: 'assets/examine_ficha_museo.webp', furniture: 'none', speaker: 'NARRADOR', text: 'La máquina con la que se escribió tiene un defecto: todas las eses caen media línea por debajo del renglón.' },
