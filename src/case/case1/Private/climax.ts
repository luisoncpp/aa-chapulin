...
const STAGE_4_SUCCESS: DialogueLine[] = [
  ...
  { speaker: 'NARRADOR', text: 'El escándalo de la galería tarda medio minuto en bajar.', bg: 'assets/bg_gallery_characters.webp', furniture: 'none', sfx: 'realization', bgm: 'pursuit' },
  ...
  { speaker: 'NARRADOR', text: 'Silencio absoluto en la sala.', bg: 'assets/bg_gallery_characters.webp', furniture: 'none', bgm: 'suspense' },
