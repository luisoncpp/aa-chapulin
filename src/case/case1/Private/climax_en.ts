...
const STAGE_4_SUCCESS_EN: DialogueLine[] = [
  ...
  { bg: PLATE, furniture: 'none', speaker: 'NARRADOR', text: 'A typewritten card the size of a library index card.' },
  { bg: PLATE, furniture: 'none', speaker: 'NARRADOR', text: '"One. Loading door latch: broken since March. Push it."' },
  { bg: PLATE, furniture: 'none', speaker: 'NARRADOR', text: '"Two. Gallery 2 grate: 18 × 24. Mesh loose at the lower corner. Opens onto the yard."' },
  { bg: PLATE, furniture: 'none', speaker: 'NARRADOR', text: '"Three. Watchman: 20:45 the forward hold. 21:00 the after hold. Copied from his notebook; hangs from a nail in the booth."' },
  { bg: PLATE, furniture: 'none', speaker: 'NARRADOR', text: '"Four. Chiquitolina pills: pharmacy on Insurgentes, the back counter."' },
  { bg: PLATE, furniture: 'none', speaker: 'NARRADOR', text: '"Five. Camera roll: changed on Mondays. On Tuesday one frame is left."' },
  { bg: PLATE, furniture: 'none', speaker: 'NARRADOR', text: '"Six. Closing service included. 5 min."' },
  { bg: PLATE, furniture: 'none', speaker: 'NARRADOR', text: 'On the reverse, a printed letterhead: "Enciclopedias El Saber Universal, S. A."' },
  { bg: PLATE, furniture: 'none', speaker: 'NARRADOR', text: 'The typewriter that produced it has a flaw: every s falls half a line below the baseline.' },
  ...
  { speaker: 'NARRADOR', text: 'It takes half a minute for the uproar in the gallery to die down.', sfx: 'realization', bgm: 'pursuit' },
...
const CASE1_VERDICT_EN: DialogueLine[] = [
  ...
  { speaker: 'NARRADOR', text: 'Confetti rains down over the courtroom.' },
