...
const STAGE_1_SUCCESS: DialogueLine[] = [
  ...
  { speaker: 'NARRADOR', text: 'La galería se levanta entera.', bg: 'assets/bg_gallery_characters.webp', furniture: 'none', sfx: 'realization' },
...
const STAGE_2_SUCCESS: DialogueLine[] = [
  ...
  { speaker: 'NARRADOR', text: 'La sala entera se queda inmóvil, y no por la chicharra.', bg: 'assets/bg_gallery_characters.webp', furniture: 'none', bgm: 'pursuit' },
...
const STAGE_3_SUCCESS: DialogueLine[] = [
  ...
  { speaker: 'NARRADOR', text: 'Todas las cabezas de la sala giran hacia el estrado. El testigo se aprieta las solapas del saco de raya crema.', bg: 'assets/bg_gallery_characters.webp', furniture: 'none', sfx: 'realization' },
