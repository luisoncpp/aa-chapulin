...
const STAGE_2_SUCCESS: DialogueLine[] = [
  ...
  { speaker: 'CHAPULIN', text: 'Detectan la presencia del enemigo. Y en veinte años nunca me han fallado... salvo aquella vez del perro, pero el perro también era enemigo.', pose: 'chapulin_idle' },
