...
const STAGE_1_SUCCESS_EN: DialogueLine[] = [
  ...
  { speaker: 'NARRADOR', text: 'The whole gallery rises.', bg: 'assets/bg_gallery_characters.webp', furniture: 'none', sfx: 'realization' },
...
const STAGE_2_SUCCESS_EN: DialogueLine[] = [
  ...
  { speaker: 'NARRADOR', text: 'The entire room goes still, and not because of the chicharra.', bg: 'assets/bg_gallery_characters.webp', furniture: 'none', bgm: 'pursuit' },
...
const STAGE_3_SUCCESS_EN: DialogueLine[] = [
  ...
  { speaker: 'NARRADOR', text: 'Every head in the room turns towards the stand. The witness clutches the lapels of his cream pinstriped jacket.', bg: 'assets/bg_gallery_characters.webp', furniture: 'none', sfx: 'realization' },
