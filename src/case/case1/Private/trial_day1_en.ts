...
export const CASE1_TRIAL_INTRO_EN: DialogueLine[] = [
  ...
  { bg: 'assets/bg_courtroom.webp', speaker: 'SUPER SAM', pose: 'supersam_case1_slam', text: 'Your Honor, I closed this case in five minutes. FIVE! A museum locked with a key, a watchman on the floor, and inside a gentleman dressed as a grasshopper holding a club.', sfx: 'desk_slam' },
  ...
  { bg: 'assets/bg_courtroom.webp', speaker: 'SUPER SAM', pose: 'supersam_case1_slam', text: 'With the rubber club he was holding! The curator saw it!', sfx: 'desk_slam' },
...
const CASE1_D1_T1_SUCCESS_EN: DialogueLine[] = [
  ...
  { speaker: 'DEFENSA', text: 'Two minutes. And the arrest report lists, line by line, everything he was carrying: a vinyl mallet, a box of pills, a pair of antennae and three pesos.', pose: 'donramon_idle' },
  ...
  { speaker: 'SUPER SAM', text: 'It does not matter! Even if he took nothing, he STRUCK the watchman! The witness saw him holding the weapon!', pose: 'supersam_point' },
  { speaker: 'JUEZ', text: 'That is true. Defense: the court wants to see that club.', pose: 'judge_neutral' }
];

const CASE1_D1_T1_FOLLOWUP_EN: DialogueLine[] = [
  { speaker: 'DEFENSA', text: 'Gladly, Your Honor. Bailiff, if you would be so kind as to squeeze it.', pose: 'donramon_idle', bgm: 'pursuit' },
  { speaker: 'NARRADOR', text: 'The bailiff squeezes the Chipote Chillón in the middle of the courtroom.', sfx: 'chipote' },
  { speaker: 'NARRADOR', text: 'A rubber squeak fills the hearing room. Somebody in the gallery laughs.', sfx: 'chipote' },
  { speaker: 'JUEZ', text: 'Order! ORDER IN THE COURT!', sfx: 'gavel', pose: 'judge_shock' },
  { speaker: 'DEFENSA', text: 'Soft vinyl, hollow inside, two hundred grams. This does not fracture a skull, Your Honor: it ruins a hairstyle.', pose: 'donramon_point' },
  { speaker: 'FLORINDA', text: 'But I saw him holding it!', pose: 'florinda_crying' },
  { speaker: 'DEFENSA', text: 'And I believe you, madam. I believe all of it. You saw a man standing with a toy in his hand, and from there to "he struck him" is a leap the prosecution took, not you.', pose: 'donramon_idle', updateProfile: 'perfil_florinda' },
  { speaker: 'SUPER SAM', text: 'Objection! Being soft does not prove it was not used! Maybe he hit him very hard!', pose: 'supersam_sweat' },
  { speaker: 'JUEZ', text: 'The prosecution is right, however hard that is to say. A soft object is still an object.', pose: 'judge_thinking' },
  { speaker: 'JUEZ', text: 'The court will not rule out the mallet on a squeak. It needs an expert report. And it needs the witness who did see the blow.', sfx: 'gavel', pose: 'judge_gavel' },
...
export const CASE1_TESTIMONY_1_EN: Testimony = {
  ...
  statements: [
    ...
    },
    {
      ...
      speaker: 'FLORINDA',
      pose: 'florinda_angry',
      text: 'I opened the big door and there was my watchman on the ground, and that red bug standing beside him with the club in his hand.',
      pressText: [
        ...
        { speaker: 'DEFENSA', text: 'Unless the axe is made of rubber, counselor.', pose: 'donramon_idle' }
      ]
    },
    {
      id: 'c1_d1t1_4',
      ...
      contradiction: {
        ...
        followUp: {
          ...
          prompt: 'What exactly is the object the witness saw in his hands?',
          successDialogue: CASE1_D1_T1_FOLLOWUP_EN
        }
      }
    }
  ]
