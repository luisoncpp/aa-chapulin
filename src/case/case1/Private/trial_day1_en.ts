...
export const CASE1_TRIAL_INTRO_EN: DialogueLine[] = [
  ...
  { bg: 'assets/bg_defense.webp', speaker: 'DEFENSA', pose: 'donramon_idle', text: '(Prosecutor Super Sam. Paid by the closed case. Twice I have faced him and both times he had his dollar bag on his shoulder. Today he took the floor without it. I am writing that down, if only out of nosiness.)', addProfile: 'perfil_supersam' },
