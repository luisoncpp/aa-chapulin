...
const CASE1_GIRO_1: DialogueLine[] = [
  ...
  { speaker: 'JUEZ', text: 'Alguien caminó hasta ese museo cargando un saco de moneda metálica la noche del veintiuno de agosto.', pose: 'judge_neutral' },
  ...
  { speaker: 'DEFENSA', text: 'Hoy no la trae. ¿Dónde estaba esa bolsa la noche del veintiuno?', pose: 'donramon_slam', sfx: 'desk_slam', cutin: 'objection_protesto' },
...
const CASE1_D1_T2_SUCCESS: DialogueLine[] = [
  ...
  { speaker: 'DEFENSA', text: 'Pero el Chipote es vinil hueco y pesa doscientos gramos. El informe exige un objeto pesado, denso y sin aristas.', pose: 'donramon_slam', sfx: 'desk_slam', updateEvidence: 'informe_medico' },
...
export const CASE1_TESTIMONY_2: Testimony = {
  ...
  statements: [
    ...
    },
    {
      ...
      speaker: 'TRIPASECA',
      pose: 'tripaseca_smug',
      text: 'Levantó el garrote y le dio al velador en la nuca. Un solo golpe, pero bien dado.',
      pressText: [
    ...
    },
    {
      ...
      speaker: 'TRIPASECA',
      pose: 'tripaseca_smug',
      text: 'Y ese garrote de hule no sonó a juguete... mire, yo he oído golpes en mi vida. Sonó a costalazo de fierros.',
      pressText: [
        ...
        { speaker: 'TRIPASECA', text: 'Pos ese garrote, licenciado. Sonó como cuando se le cae a uno una caja de tornillos. Chin, chin, chin. Fierros.', pose: 'tripaseca_smug' },
