...
const CASE1_GIRO_1: DialogueLine[] = [
  ...
  { speaker: 'NARRADOR', text: 'La sala estalla. El Juez golpea el mazo tres veces.', bg: 'assets/bg_gallery_characters.webp', furniture: 'none', sfx: 'gavel' },
  ...
  { speaker: 'NARRADOR', text: 'Silencio absoluto.', bg: 'assets/bg_gallery_characters.webp', furniture: 'none', bgm: 'suspense' },
