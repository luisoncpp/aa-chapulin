...
const CASE1_GIRO_1_EN: DialogueLine[] = [
  ...
  { speaker: 'NARRADOR', text: 'The room erupts. The Judge strikes the gavel three times.', bg: 'assets/bg_gallery_characters.webp', furniture: 'none', sfx: 'gavel' },
  { speaker: 'JUEZ', text: 'ORDER!', sfx: 'gavel', pose: 'judge_gavel' },
  { speaker: 'JUEZ', text: 'Somebody walked to that museum carrying a sack of metal coin on the night of August the twenty-eighth.', pose: 'judge_neutral' },
  ...
  { speaker: 'DEFENSA', text: 'Today you are not carrying it. Where was that bag on the night of the twenty-eighth?', pose: 'donramon_slam', sfx: 'desk_slam', cutin: 'objection_protesto' },
  { speaker: 'NARRADOR', text: 'Absolute silence.', bg: 'assets/bg_gallery_characters.webp', furniture: 'none', bgm: 'suspense' },
