...
const CASE1_GIRO_2_EN: DialogueLine[] = [
  ...
  { speaker: 'NARRADOR', text: 'The room falls silent.', bg: 'assets/bg_gallery_characters.webp', furniture: 'none', sfx: 'realization' },
...
const CASE1_D2_T3_SUCCESS_EN: DialogueLine[] = [
  ...
  { speaker: 'NARRADOR', text: 'Uproar in the gallery.', bg: 'assets/bg_gallery_characters.webp', furniture: 'none', sfx: 'gavel' },
...
const CASE1_D2_T3_FOLLOWUP_EN: DialogueLine[] = [
  ...
  { speaker: 'NARRADOR', text: 'The gallery rises. Alma Negra grips the arm of his chair.', bg: 'assets/bg_gallery_characters.webp', furniture: 'none', sfx: 'realization' },
