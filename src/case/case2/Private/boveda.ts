  ...
  hotspots: [
    {
      ...
      x: 16, y: 16, w: 36, h: 58,
      dialogue: [
        { speaker: 'DEFENSA', text: 'Miren esto... una caja blindada con cerradura de llave maestra, y ni una sola marca de forcejeo con palanca.', pose: 'donramon_idle', sfx: 'realization', addEvidence: 'informe_boveda' }
      ]
    },
    {
      id: 'hotspot_reloj',
      ...
      x: 54, y: 8, w: 12, h: 44,
      dialogue: [
        { speaker: 'CHAPULIN', text: '¡Miren ese reloj! ¡Se durmió temprano! Marca las 9:15 PM y no se mueve.', pose: 'chapulin_idle', addEvidence: 'reloj_pendulo' },
        { speaker: 'PETERETE', text: 'Tonterías. Ese reloj es una antigüedad decorativa que no funciona desde el siglo pasado.', pose: 'peterete_smug', unlockLocation: 'restaurante' }
      ]
    },
    {
      id: 'hotspot_rejilla',
      ...
      x: 70, y: 30, w: 16, h: 28,
      dialogue: [
        { speaker: 'CHAPULIN', text: '¡Mmm! Huele a perfume de rosas y té de tila... ¡igualito al que toma Doña Clotilde para los sustos!', pose: 'chapulin_idle' },
