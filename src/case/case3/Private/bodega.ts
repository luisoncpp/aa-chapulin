...
export const CASE3_BODEGA: InvestigationScene = {
  ...
  intro: [
    ...
    { speaker: 'CHAPULIN', text: '¡Mis antenitas de vinil ya están haciendo temblorcito!', pose: 'chapulin_thinking' }
  ],
  ...
  talkOptions: [
    {
      ...
      dialogue: [
        { speaker: 'DEFENSA', text: 'Tres cuartos de hora amordazado... y el polvo no muestra forcejeo. Eso no cuadra.', pose: 'donramon_point' },
