...
export const CASE3_CLIMAX: ClimaxDefinition = assembleCase3Climax({
  dialogue: [
    { speaker: 'JUEZ', text: 'Licenciado Don Ramón, este tribunal ya no discute si su cliente es inocente. Discute quién es culpable. Y para eso hacen falta cuatro cosas: cuándo se grabó, dónde se grabó, quién podía grabarlo y por qué.', bgm: 'suspense', pose: 'judge_thinking' },
    { speaker: 'DEFENSA', text: '(Cuatro clavos, Don Ramón. Uno por uno, y sin fallar ninguno.)', pose: 'donramon_idle' },
