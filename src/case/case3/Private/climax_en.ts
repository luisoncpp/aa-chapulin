...
const STAGE2: DialogueLine[] = [
  ...
  { speaker: 'DEFENSA', text: 'And only one other booth was occupied that night! Cabina A!', pose: 'donramon_point' },
...
const EPILOGUE: DialogueLine[] = [
  ...
  { bg: WAITING_ROOM, furniture: 'none', speaker: 'PAZGUATO', text: '¡Mi Licenciado! The prosecutor docked my paycheck again! Says it was for "olfactory insubordination" over the trash!', pose: 'pazguato_decidido' },
  { bg: WAITING_ROOM, furniture: 'none', speaker: 'BARRIGA', text: 'Sergeant, the station needs a night watchman. An honest one. Interested?', pose: 'barriga_idle' },
  { bg: WAITING_ROOM, furniture: 'none', speaker: 'PAZGUATO', text: '¡A sus órdenes! And do you pay... with money?', pose: 'pazguato_saludo' },
  { bg: WAITING_ROOM, furniture: 'none', speaker: 'BARRIGA', text: 'With money, Sergeant. And speaking of money, Licenciado Monchito...', pose: 'barriga_idle' },
  ...
  { bg: WAITING_ROOM, furniture: 'none', speaker: 'BARRIGA', text: 'What fees? The doctor didn\'t pay you!', pose: 'barriga_idle' },
