...
export const CASE3_DELEGACION: InvestigationScene = {
  ...
  intro: [
    ...
    { speaker: 'PAZGUATO', text: 'Pásele, Licenciado. ¿Gusta? Es torta de frijoles. Ya nomás como de frijoles porque el fiscal me dejó la quincena en catorce pesos.', pose: 'pazguato_sweat' },
    { speaker: 'DEFENSA', text: 'No, gracias, sargento. ¿Qué recogió usted de la cabina de control?', pose: 'donramon_idle' },
    { speaker: 'PAZGUATO', text: 'Aquí traigo la bitácora de transmisión, mi Licenciado. Ahí apunta la consola todo lo que sale al aire, solita.', pose: 'pazguato_decidido', addEvidence: 'bitacora_transmision' },
    ...
    { speaker: 'PAZGUATO', text: 'Sí, ¿verdad? Yo también le entendí re\' poquito.', pose: 'pazguato_sweat' },
  ...
  hotspots: [
    {
      ...
      x: 68, y: 18, w: 24, h: 48,
      dialogue: [
        { speaker: 'PAZGUATO', text: 'Ahí guardo lo que no me descuenta el fiscal. Por ahora, puro papel.', pose: 'pazguato_idle' }
      ]
    },
    {
      id: 'hotspot_torta',
  ...
  talkOptions: [
    {
      ...
      dialogue: [
        { speaker: 'PAZGUATO', text: 'Es que... yo me llevé el carrete grandote de la Cabina A. Pensé que era el bueno. Los cartuchos se me quedaron... en algún lado de la estación.', pose: 'pazguato_sweat' },
        { speaker: 'DEFENSA', text: '(El cartucho 3 sigue perdido. Y es la grabación del grito.)', pose: 'donramon_idle' },
        { speaker: 'PAZGUATO', text: 'Si me dan chance, yo lo busco. Aunque tenga que meter las manitas en la basura.', pose: 'pazguato_decidido' }
      ]
    }
  ]
};
