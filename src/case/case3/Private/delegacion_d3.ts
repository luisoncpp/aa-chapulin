...
export const CASE3_DELEGACION_D3: InvestigationScene = {
  ...
  speaker: 'NARRADOR',
  intro: [
    { speaker: 'NARRADOR', text: '18 de septiembre, 8:00 AM. El sargento no se ha cambiado de uniforme. Ni piensa hacerlo.' },
    { speaker: 'PAZGUATO', text: '¡Mi Licenciado! ¡Toda la noche en los tambos de basura de la estación! ¡Ocho horas! ¡Con estas manitas!', pose: 'pazguato_decidido' },
    { speaker: 'CHAPULIN', text: '¡Y con mis antenitas de vinil! ¡Vibraron re\' feo sobre el tambo del callejón!', pose: 'chapulin_point' },
    { speaker: 'PAZGUATO', text: 'Ahí estaba, mi Licenciado. Debajo de las cáscaras. Cartucho tres.', pose: 'pazguato_decidido', addEvidence: 'cartucho_corte' },
    ...
    { speaker: 'DEFENSA', text: 'O sea que a las 9:40, mientras el señor Barriga buscaba a Quico en la plaza... ALGUIEN estaba grabando su voz en una cabina.', pose: 'donramon_point' },
    { speaker: 'PAZGUATO', text: '¿Y eso qué significa, mi Licenciado?', pose: 'pazguato_sweat' },
  ...
  talkOptions: [
    {
      ...
      dialogue: [
        { speaker: 'PAZGUATO', text: 'Y ya encarrerado me fui al Monte de Piedad, mi Licenciado. Ese micrófono estuvo empeñado desde junio. Lo desempeñaron el 3 de septiembre. Doce mil pesos. En efectivo.', pose: 'pazguato_decidido', addEvidence: 'boleta_empeno', updateEvidence: 'microfono_oro' },
    ...
    },
    {
      ...
      dialogue: [
        { speaker: 'CHAPULIN', text: '¡Con el lapicito de lado, como en la escuela! ¡Ya salió! Dice: \'Faltan cuarenta mil. Los retiros los firmó el tesorero. Se lo diré al aire.\'', pose: 'chapulin_point', sfx: 'realization', updateEvidence: 'libro_verde', unlockLocation: 'centro_detencion_d3' },
        { speaker: 'DEFENSA', text: '(El Señor Barriga iba a denunciar al tesorero... al aire. En su propia estación.)', pose: 'donramon_shock' }
      ]
    }
  ]
};
