  ...
  statements: [
    {
      ...
      pressText: [
        ...
        { speaker: 'SARGENTO', text: '¡A sus órdenes! Sí, mi Licenciado. Corrí enseguida al edificio.', pose: 'pazguato_saludo' }
      ]
    },
    {
      id: 'stmt1_2',
      speaker: 'SARGENTO',
      pose: 'pazguato_idle',
      text: 'Subí volando y en la puerta de la cabina me topé con el joven Ñoño. Hallamos al doctor arrodillado sobre el señor Barriga.',
      pressText: [
        { speaker: 'DEFENSA', text: '¡UN MOMENTO!', cutin: 'objection_un_momento', sfx: 'whoosh', pose: 'donramon_point' },
        { speaker: 'DEFENSA', text: '¿Qué más halló en esa cabina además del doctor y la víctima?', pose: 'donramon_idle' },
        { speaker: 'SARGENTO', text: '¡Ah! Y también estaba tirada la bolsa de papel del doctor. Adentro traía una ampolleta vacía y una jeringa recién usada.', pose: 'pazguato_sweat', addEvidence: 'bolsa_papel' },
        { speaker: 'DEFENSA', text: '¿Recién usada? Sargento, eso significa que el doctor inyectó a alguien poco antes de subir.', pose: 'donramon_idle' },
    ...
    },
    {
      ...
      speaker: 'SARGENTO',
      pose: 'pazguato_sweat',
      text: 'Y también estaba tirada la bolsa de papel del doctor, con una jeringa recién usada.',
      unlockedBy: 'stmt1_2',
      pressText: [
        { speaker: 'DEFENSA', text: '¡UN MOMENTO!', cutin: 'objection_un_momento', sfx: 'whoosh', pose: 'donramon_point' },
        { speaker: 'SARGENTO', text: 'Una ampolleta vacía de cardiotónico, mi Licenciado. Y la jeringa todavía tibia.', pose: 'pazguato_sweat', addEvidence: 'bolsa_papel' }
      ]
    },
    {
      id: 'stmt1_3',
      speaker: 'SARGENTO',
      pose: 'pazguato_idle',
      text: 'El crimen ocurrió ahí mismito, en esa cabina. El arma estaba junto al cuerpo.',
      pressText: [
        { speaker: 'DEFENSA', text: '¡UN MOMENTO!', cutin: 'objection_un_momento', sfx: 'whoosh', pose: 'donramon_point' },
      ...
      contradiction: { evidence: ['lentes_barriga', 'informe_barriga'], successDialogue: CASE3_T1_SUCCESS }
    },
    {
      id: 'stmt1_4',
      speaker: 'SARGENTO',
      pose: 'pazguato_idle',
      text: 'En el segundo piso estaban el joven Ñoño en la consola, la señora Chimoltrufia en la Cabina C, y don Aniceto amarrado en la bodega. Nadie más.',
      pressText: [
        { speaker: 'DEFENSA', text: '¡UN MOMENTO!', cutin: 'objection_un_momento', sfx: 'whoosh', pose: 'donramon_point' },
        { speaker: 'SARGENTO', text: 'Pobre don Aniceto. Al que le hicieron eso no le tembló la mano.', pose: 'pazguato_sweat' }
      ]
    }
  ]
};
