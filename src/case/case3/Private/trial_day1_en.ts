...
export const CASE3_TRIAL_INTRO_EN: DialogueLine[] = [
  ...
  { bg: 'assets/bg_courtroom.jpg', speaker: 'SUPER SAM', pose: 'supersam_point', text: 'And ninety seconds later they found him on top of the body! I want a verdict before my lunch hour!' },
  ...
  statements: [
    {
      ...
      pressText: [
        ...
        { speaker: 'PAZGUATO', text: 'Clear as day, mi Licenciado. The whole plaza jumped.', pose: 'pazguato_idle' }
      ]
    },
    {
      id: 'stmt1_2',
      speaker: 'PAZGUATO',
      pose: 'pazguato_idle',
      text: 'I flew upstairs with young Ñoño and we found the doctor kneeling over Señor Barriga.',
      pressText: [
        { speaker: 'DEFENSA', text: 'HOLD IT!', cutin: 'objection_un_momento', sfx: 'whoosh', pose: 'donramon_point' },
        { speaker: 'DEFENSA', text: 'What else did you find in that booth besides the doctor and the victim?', pose: 'donramon_idle' },
        { speaker: 'PAZGUATO', text: 'Ah! And there was something else on the floor...', pose: 'pazguato_sweat' }
      ]
    },
    {
      id: 'stmt1_2b',
      speaker: 'PAZGUATO',
      pose: 'pazguato_sweat',
      text: 'Ah! And the doctor\'s paper bag was lying there too. Inside: an empty cardiotonic ampule and a freshly used syringe.',
      unlockedBy: 'stmt1_2',
      pressText: [
        { speaker: 'DEFENSA', text: 'Freshly used? Sergeant, that means the doctor injected someone shortly before going up.', pose: 'donramon_idle', addEvidence: 'bolsa_papel' },
    ...
    },
    {
      ...
      speaker: 'PAZGUATO',
      pose: 'pazguato_idle',
      text: 'The weapon — that is, the trophy — was right there, exactly as the criminal left it.',
      pressText: [
        { speaker: 'DEFENSA', text: 'HOLD IT!', cutin: 'objection_un_momento', sfx: 'whoosh', pose: 'donramon_point' },
        { speaker: 'PAZGUATO', text: 'Well... for the photo it looked better neat, so I moved it before...', pose: 'pazguato_sweat' },
        { speaker: 'SUPER SAM', text: 'YOUR SALARY IS CUT! Another paycheck!', pose: 'supersam_slam', sfx: 'desk_slam' },
        { speaker: 'PAZGUATO', text: 'That makes four, my prosecutor. At this rate I\'ll owe you.', pose: 'pazguato_sweat' }
      ],
      contradiction: {
        evidence: ['lentes_barriga', 'informe_medico'],
    ...
    },
    {
      ...
      speaker: 'PAZGUATO',
      pose: 'pazguato_idle',
      text: 'On the whole second floor there was nobody else... except Don Aniceto, tied up in the storeroom.',
      pressText: [
        { speaker: 'DEFENSA', text: 'HOLD IT!', cutin: 'objection_un_momento', sfx: 'whoosh', pose: 'donramon_point' },
        { speaker: 'PAZGUATO', text: 'Poor Don Aniceto. Whoever tied him had a steady hand.', pose: 'pazguato_sweat' }
      ]
    }
  ]
};
