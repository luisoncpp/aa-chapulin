  ...
  statements: [
    {
      ...
      text: 'A las 10:55 bajé a la bodega por los discos del aniversario.',
      pressText: [
        { speaker: 'DEFENSA', text: '¡UN MOMENTO!', cutin: 'objection_un_momento', sfx: 'whoosh', pose: 'donramon_point' },
        { speaker: 'ANICETO', text: 'Discos del aniversario de la estación. Veinticinco años al aire.', pose: 'aniceto_terciopelo' }
      ]
    },
    {
      id: 'stmt4_2',
      ...
      pressText: [
        ...
        { speaker: 'ANICETO', text: 'Con mi propio pañuelo de seda, ese que siempre llevo al cuello.', pose: 'aniceto_terciopelo' }
      ]
    },
    {
      id: 'stmt4_2b',
      speaker: 'ANICETO',
      pose: 'aniceto_terciopelo',
      text: 'Me lo quitaron y me lo metieron en la boca. Qué humillación.',
      unlockedBy: 'stmt4_2',
      pressText: [
        { speaker: 'DEFENSA', text: '(¿Su propio pañuelo? Sargento... ¿esas ataduras siguen tiradas en la bodega?)', pose: 'donramon_idle' },
        { speaker: 'PAZGUATO', text: 'Uy. Sí. Nadie las recogió.', pose: 'pazguato_sweat' }
      ]
    },
    {
      id: 'stmt4_3',
      ...
      pressText: [
        { speaker: 'DEFENSA', text: '¡UN MOMENTO!', cutin: 'objection_un_momento', sfx: 'whoosh', pose: 'donramon_point' },
        { speaker: 'ANICETO', text: 'Pasos de persona muy mayor. El doctor Chapatín, sin duda.', pose: 'aniceto_terciopelo' }
      ],
