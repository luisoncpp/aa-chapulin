  ...
  statements: [
    {
      ...
      speaker: 'ANICETO',
      pose: 'aniceto_idle',
      text: 'At 10:50 I went down to the storeroom for the anniversary records.',
      pressText: [
        { speaker: 'DEFENSA', text: 'HOLD IT!', cutin: 'objection_un_momento', sfx: 'whoosh', pose: 'donramon_point' },
        { speaker: 'ANICETO', text: 'Twenty-five years of anniversaries. Someone has to fetch the discs.', pose: 'aniceto_idle' }
      ]
    },
    {
      id: 'stmt4_2',
      ...
      pressText: [
        { speaker: 'DEFENSA', text: 'HOLD IT!', cutin: 'objection_un_momento', sfx: 'whoosh', pose: 'donramon_point' },
        { speaker: 'ANICETO', text: 'They gagged me with my own silk handkerchief — the one I always used to wear at my neck. They took it and stuffed it in my mouth. What humiliation.', pose: 'aniceto_sweat' },
        { speaker: 'DEFENSA', text: '(His own handkerchief? Sergeant... are those bonds still lying in the storeroom?)', pose: 'donramon_idle' },
        { speaker: 'SARGENTO', text: 'Uy. Yes. Nobody picked them up.', pose: 'pazguato_sweat' }
      ]
    },
    {
      id: 'stmt4_2b',
      speaker: 'ANICETO',
      pose: 'aniceto_sweat',
      text: 'They gagged me with my own silk handkerchief, the one I always used to wear at my neck.',
      unlockedBy: 'stmt4_2',
      pressText: [
        { speaker: 'DEFENSA', text: 'HOLD IT!', cutin: 'objection_un_momento', sfx: 'whoosh', pose: 'donramon_point' },
    ...
    },
    {
      ...
      pressText: [
        { speaker: 'DEFENSA', text: 'HOLD IT!', cutin: 'objection_un_momento', sfx: 'whoosh', pose: 'donramon_point' },
        { speaker: 'ANICETO', text: 'I know elderly steps. I\'ve narrated enough funerals.', pose: 'aniceto_idle' }
      ],
      contradiction: {
