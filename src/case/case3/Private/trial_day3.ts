...
import { CASE3_CALL_BARRIGA } from './witness_calls.js';

export const CASE3_DAY3_INTRO: DialogueLine[] = [
  { bg: 'assets/bg_waiting_room.webp', furniture: 'none', speaker: 'NARRADOR', text: '18 de septiembre, 6:00 PM. Tribunal Superior - Sala de Espera.', bgm: 'trial' },
