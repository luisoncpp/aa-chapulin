...
export const CASE3_T5_SUCCESS: DialogueLine[] = [
  { cutin: 'objection_protesto', speaker: 'DEFENSA', text: '¡PROTESTO! ¡Señor Juez, antes de continuar quiero que conste algo!', sfx: 'whoosh', bgm: 'pursuit', pose: 'donramon_point' },
  ...
  { speaker: 'CHAPULIN', text: '¡Y hay más! ¡Tres cuartos de hora amarrado y las muñecas sin una raspadura! ¡Y en el polvo del piso no hay ni una marca de forcejeo, nomás la sentadita!', sfx: 'desk_slam', pose: 'chapulin_slam' },
