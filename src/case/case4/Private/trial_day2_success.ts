...
export const CASE4_D2_T1_RESIDUOS_SUCCESS: DialogueLine[] = [
  ...
  { speaker: 'DEFENSA', text: '¡Es carbón mineral, tizne y azufre de la chimenea de la caldera central que estuvo destapando por órdenes de Don Cecilio antes de subir al tercer piso!', sfx: 'desk_slam', pose: 'donramon_slam', updateEvidence: 'residuos_manos' },
  { speaker: 'SUPER SAM', text: 'But... but the gunshot at 11:15 PM! ¡El estruendo del disparo lo oyó todo el hotel!', pose: 'supersam_sweat' },
  { speaker: 'DEFENSA', text: '¡Y aquí se derrumba la farsa de la fiscalía!', sfx: 'desk_slam', bgm: 'suspense', pose: 'donramon_point' }
];

export const CASE4_D2_T1_FORENSE_FOLLOWUP: DialogueLine[] = [
...
export const CASE4_D2_T2_CASQUILLO_SUCCESS: DialogueLine[] = [
  { speaker: 'DEFENSA', text: '¡Fue una trampa acústica fabricada con este casquillo de fogueo con mecha lenta, detonado dentro del tubo de purga de la Suite 204!', pose: 'donramon_slam', sfx: 'desk_slam' },
