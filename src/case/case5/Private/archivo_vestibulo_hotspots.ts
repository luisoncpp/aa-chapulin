...
export const CASE5_VESTIBULO_HOTSPOTS: Hotspot[] = [
  {
    ...
    dialogue: [
      ...
      { speaker: 'NICANOR', text: 'Uniformados no firman, joven. Nunca han firmado. Este libro es para las visitas: el que viene de fuera a consultar y nada más.', pose: 'nicanor_idle' },
      { speaker: 'DEFENSA', text: '¿Y el que trabaja en el edificio?', pose: 'chapulin_point' },
      { speaker: 'NICANOR', text: 'Ése entra a trabajar, joven, no viene de visita. Yo no me firmo a mí mismo.', pose: 'nicanor_idle' },
      { speaker: 'DEFENSA', text: '(O sea que este libro no dice quién estuvo en el edificio. Nada más dice quién vino de visita.)', pose: 'chapulin_idle', addEvidence: 'libro_visitas' }
    ]
  },
  {
    id: 'hotspot_plano',
    ...
    dialogue: [
      ...
      { speaker: 'DEFENSA', text: '¿Y ésos pasan por su mostrador?', pose: 'chapulin_point' },
      { speaker: 'NICANOR', text: 'Ni por mi mostrador ni por mi libro. Entran por su ventanilla y yo ni les veo la cara.', pose: 'nicanor_idle' },
      { speaker: 'DEFENSA', text: '...¿Y entonces quién apunta a ésos?', pose: 'chapulin_panic' },
      { speaker: 'NICANOR', text: 'La señorita Genoveva, joven. Cada quien su puerta y cada quien su pena.', pose: 'nicanor_escoba' },
