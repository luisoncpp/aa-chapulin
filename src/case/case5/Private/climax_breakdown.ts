...
export const CASE5_CLIMAX_BREAKDOWN: DialogueLine[] = [
  ...
  { speaker: 'BERRONDO', text: 'Yo no heredé un archivo muerto.', pose: 'berrondo_breakdown', bgm: 'pursuit' },
  { speaker: 'BERRONDO', text: '¡Yo lo mantuve vivo!', pose: 'berrondo_breakdown', sfx: 'desk_slam' },
  { speaker: 'NARRADOR', text: 'El licenciado Berrondo se levanta de la mesa de la fiscalía. Se le cae la leontina del chaleco y no la recoge.', sfx: 'realization' },
  { speaker: 'BERRONDO', text: '¡Once mil cuatrocientas familias le abrieron la puerta a un vendedor y le contaron todo lo que tenían!', pose: 'berrondo_breakdown' },
  { speaker: 'BERRONDO', text: '¡Yo no fui a ninguna casa! ¡Yo no toqué ninguna puerta! ¡Yo no le puse la mano encima a nadie en veintisiete años!', pose: 'berrondo_breakdown' },
  { speaker: 'DEFENSA', text: 'Hasta el sábado.', pose: 'chapulin_idle' },
  { speaker: 'BERRONDO', text: '¡Ese hombre iba a decir mi nombre!', pose: 'berrondo_breakdown' },
  { speaker: 'NARRADOR', text: 'Silencio absoluto.', bgm: 'suspense' },
  { speaker: 'BERRONDO', text: '...Ese hombre iba a decir mi nombre.', pose: 'berrondo_panic' },
  { speaker: 'BERRONDO', text: 'Y no me acordaba de él.', pose: 'berrondo_panic' },
  { speaker: 'BERRONDO', text: 'Estuve dos horas el sábado en la noche buscándolo en una fotografía de mil novecientos sesenta y nueve, y no me acordaba de él.', pose: 'berrondo_breakdown' },
  ...
  { speaker: 'BERRONDO', text: '...Homicidio.', pose: 'berrondo_breakdown' },
  { speaker: 'BERRONDO', text: 'Del latín homo, hombre. Y caedere...', pose: 'berrondo_breakdown' },
  ...
  { speaker: 'NARRADOR', text: 'Berrondo se sienta. Se queda mirando la leontina en el piso y no la recoge.', bgm: 'suspense' },
