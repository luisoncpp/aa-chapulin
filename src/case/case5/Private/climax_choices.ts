...
export const CASE5_CLIMAX_CHOICES: ChoicePrompt[] = [
  {
    ...
    successDialogue: [
      ...
      { speaker: 'BERRONDO', text: '¡Señor juez, ese cajón tiene mil trescientas tarjetas! ¡Nos va a tomar la noche entera!', pose: 'berrondo_panic', bg: 'assets/bg_courtroom.webp' },
