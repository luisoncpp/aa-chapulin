...
export const CASE5_CLIMAX_STAGE2: ClimaxStage = {
  ...
  successDialogue: [
    ...
    { speaker: 'BERRONDO', text: 'Nadie, licenciado. Ya lo dijimos: el portón no tiene garita.', pose: 'berrondo_idle', bg: 'assets/bg_courtroom.webp' },
    { speaker: 'BERRONDO', text: 'Pero esa moneda cae de los dos lados. Que nadie me viera salir tampoco prueba que me quedara.', pose: 'berrondo_idle', bg: 'assets/bg_courtroom.webp' },
