...
export const CASE5_CLIMAX_STAGE2_EN: ClimaxStage = {
  ...
  successDialogue: [
    ...
    { speaker: 'BERRONDO', text: 'Nobody, counselor. We already said it: the gate has no guard booth.', pose: 'berrondo_idle', bg: 'assets/bg_courtroom.webp' },
    { speaker: 'BERRONDO', text: 'But the coin falls both ways. That nobody saw me leave does not prove I stayed.', pose: 'berrondo_idle', bg: 'assets/bg_courtroom.webp' },
