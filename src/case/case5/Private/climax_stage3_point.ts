...
export const CASE5_CLIMAX_STAGE3_POINT: PointTargetContradiction = {
  ...
  zones: [
    ...
    { id: 'hueco_13', bounds: [53, 16, 60, 72], isCorrect: false, failureDialogue: ZONE_FAIL('Ese hueco lleva vacío desde 1971 y de él vamos a hablar dentro de un minuto, licenciado. Pero yo le pregunté qué hay de más, no qué falta.') },
