 ...
 * Point-zone bounds measured on the regenerated `examine_estante_consulta.webp` (spines, gap, base).
 */
...
export const CASE5_CLIMAX_STAGE3_POINT: PointTargetContradiction = {
  ...
  zones: [
    ...
    { id: 'lomo_11', bounds: [41, 12, 47, 74], isCorrect: true, failureDialogue: [] },
    { id: 'hueco_13', bounds: [49, 16, 55, 70], isCorrect: false, failureDialogue: ZONE_FAIL('Ese hueco lleva vacío desde 1971 y de él vamos a hablar dentro de un minuto, licenciado. Pero yo le pregunté qué hay de más, no qué falta.') },
