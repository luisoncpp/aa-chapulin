...
export const CASE5_CLIMAX_STAGE3_POINT_EN: PointTargetContradiction = {
  ...
  zones: [
    ...
    { id: 'hueco_13', bounds: [49, 16, 55, 70], isCorrect: false, failureDialogue: ZONE_FAIL('That gap has been empty since 1971 and we will talk about it in a minute, counselor. But I asked what is extra, not what is missing.') },
