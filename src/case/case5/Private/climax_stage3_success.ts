...
export const CASE5_CLIMAX_STAGE3_POINT_SUCCESS: DialogueLine[] = [
  ...
  { bg: 'assets/bg_gallery_characters.webp', furniture: 'none', speaker: 'NARRADOR', text: 'La sala entera se inclina hacia la lámina.', sfx: 'realization', bgm: 'pursuit' },
  ...
  { bg: 'assets/bg_gallery_characters.webp', furniture: 'none', speaker: 'NARRADOR', text: 'Cuatro minutos. Nadie se sienta.', bgm: 'suspense' },
  ...
  { bg: 'assets/bg_gallery_characters.webp', furniture: 'none', speaker: 'NARRADOR', text: 'La galería estalla.', sfx: 'gavel', bgm: 'objection' },
  ...
  { speaker: 'BERRONDO', text: '...Señor juez.', pose: 'berrondo_sweat', bg: 'assets/bg_courtroom.webp' },
  { speaker: 'BERRONDO', text: 'Un estante incompleto es un desorden.', pose: 'berrondo_sweat', bg: 'assets/bg_courtroom.webp' },
  { speaker: 'BERRONDO', text: 'Yo no soporto los desórdenes. Nunca los he soportado.', pose: 'berrondo_panic', bg: 'assets/bg_courtroom.webp' },
  { speaker: 'BERRONDO', text: 'Eso... eso no es un delito.', pose: 'berrondo_panic', bg: 'assets/bg_courtroom.webp' },
