...
export const CASE5_CLIMAX_STAGE3_POINT_SUCCESS: DialogueLine[] = [
  ...
  { speaker: 'JUEZ', text: '¡Alguacil! ¡Que suban ese tomo a esta sala!', sfx: 'gavel', pose: 'judge_gavel' },
  { speaker: 'NARRADOR', text: 'Cuatro minutos. Nadie se sienta.', bgm: 'suspense' },
  { speaker: 'NARRADOR', text: 'El alguacil deposita sobre el estrado un volumen pesado, encuadernado en media piel, con cantoneras de latón en el canto del lomo.' },
