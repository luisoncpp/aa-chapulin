...
export const CASE5_CLIMAX_STAGE3_POINT_SUCCESS_EN: DialogueLine[] = [
  ...
  { speaker: 'NARRADOR', text: 'The bailiff sets on the bench the forensic photograph of the shelf and, beside it, a heavy volume, half-leather bound, with brass corners on the spine edge.' },
