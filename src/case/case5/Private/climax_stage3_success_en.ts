...
export const CASE5_CLIMAX_STAGE3_POINT_SUCCESS_EN: DialogueLine[] = [
  ...
  { speaker: 'NARRADOR', text: 'The whole courtroom leans toward the plate.', sfx: 'realization', bgm: 'pursuit' },
  { speaker: 'JUEZ', text: 'Bailiff! Bring that volume up to this courtroom!', sfx: 'gavel', pose: 'judge_gavel' },
  { speaker: 'NARRADOR', text: 'Four minutes. Nobody sits.', bgm: 'suspense' },
  { speaker: 'NARRADOR', text: 'The bailiff sets on the bench a heavy volume, half-leather bound, with brass corners on the spine edge.' },
  ...
  { speaker: 'NARRADOR', text: 'The gallery erupts. The Judge bangs the gavel six times.', sfx: 'gavel', bgm: 'objection' },
  ...
  { speaker: 'BERRONDO', text: '...Your Honor.', pose: 'berrondo_sweat' },
  { speaker: 'BERRONDO', text: 'An incomplete shelf is disorder.', pose: 'berrondo_sweat' },
  { speaker: 'BERRONDO', text: 'I cannot bear disorder. I never have.', pose: 'berrondo_panic' },
  { speaker: 'BERRONDO', text: 'That... is not a crime.', pose: 'berrondo_panic' },
