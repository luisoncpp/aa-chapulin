...
export const CASE5_CLIMAX_STAGE4: ClimaxStage = {
  ...
  successDialogue: [
    ...
    { speaker: 'DEFENSA', text: 'La tarjeta del cedulario correspondiente a la vecindad de la calle del Espanto número ocho, vivienda setenta y dos.', pose: 'chapulin_point' },
    { speaker: 'JUEZ', text: 'Léala, licenciado. Campo por campo.', sfx: 'gavel', bgm: 'suspense', pose: 'judge_gavel' },
    { speaker: 'DEFENSA', text: '«Domicilio: vecindad de la calle del Espanto ocho, vivienda setenta y dos.»', pose: 'chapulin_idle' },
    ...
    { bg: 'assets/bg_gallery_characters.webp', furniture: 'none', speaker: 'NARRADOR', text: 'Murmullo largo y feo en la galería.', sfx: 'realization' },
    ...
    { bg: 'assets/bg_gallery_characters.webp', furniture: 'none', speaker: 'NARRADOR', text: 'La sala estalla.', sfx: 'gavel', bgm: 'pursuit' },
    ...
    { speaker: 'JUEZ', text: '¡Alguacil! ¡El fragmento hallado en la mano de la víctima!', sfx: 'gavel', pose: 'judge_gavel' },
    ...
    { speaker: 'SECRETARIO', text: 'Diente por diente. Y los cuatro renglones del campo domicilio se completan: «...cindad de la calle del Espanto 8, viv. 72.»' },
    ...
    { speaker: 'BERRONDO', text: '...Cualquiera pudo arrancarla, señor juez.', pose: 'berrondo_panic', bg: 'assets/bg_courtroom.webp' },
