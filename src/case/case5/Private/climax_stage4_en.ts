...
export const CASE5_CLIMAX_STAGE4_EN: ClimaxStage = {
  ...
  successDialogue: [
    ...
    { bg: 'assets/bg_gallery_characters.webp', furniture: 'none', speaker: 'NARRADOR', text: 'A long, ugly murmur runs through the gallery.', sfx: 'realization' },
    ...
    { bg: 'assets/bg_gallery_characters.webp', furniture: 'none', speaker: 'NARRADOR', text: 'The courtroom erupts.', sfx: 'gavel', bgm: 'pursuit' },
