...
export const CASE5_CLIMAX_STAGE4_EN: ClimaxStage = {
  ...
  successDialogue: [
    ...
    { speaker: 'DEFENSA', text: 'The card from the file for Calle del Espanto number eight, apartment four.', pose: 'chapulin_point' },
    { speaker: 'JUEZ', text: 'Read it, counselor. Field by field.', sfx: 'gavel', bgm: 'suspense', pose: 'judge_gavel' },
    { speaker: 'DEFENSA', text: '"Address: Calle del Espanto eight, apartment four."', pose: 'chapulin_idle' },
    ...
    { speaker: 'SECRETARIO', text: 'Tooth for tooth. And the four lines of the address field complete: "...city of Calle del Espanto 8, apt. 4."' },
    ...
    { speaker: 'BERRONDO', text: '...Anyone could have torn it off, Your Honor.', pose: 'berrondo_panic' },
