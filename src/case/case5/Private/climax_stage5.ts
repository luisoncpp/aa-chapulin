...
const CASE5_CLIMAX_STAGE5_SUCCESS: ClimaxStage['successDialogue'] = [
  ...
  { bg: 'assets/bg_gallery_characters.webp', furniture: 'none', speaker: 'NARRADOR', text: 'Once minutos. Nadie se mueve de la galería.', bgm: 'suspense' },
  ...
  { bg: 'assets/bg_gallery_characters.webp', furniture: 'none', speaker: 'NARRADOR', text: 'La galería se levanta entera.', sfx: 'realization', bgm: 'objection' },
