...
const CASE5_CLIMAX_STAGE5_SUCCESS: ClimaxStage['successDialogue'] = [
  ...
  { speaker: 'BERRONDO', text: '¡SEÑOR JUEZ!', pose: 'berrondo_panic' },
  { speaker: 'BERRONDO', text: '¡Ese aparato es un bien de la masa concursal! ¡Usarlo altera el depósito!', pose: 'berrondo_panic' },
  ...
  { speaker: 'JUEZ', text: 'Señor secretario. Escriba usted, al dictado, el texto del fragmento hallado en la mano del occiso, respetando sus cuatro renglones.', sfx: 'gavel', pose: 'judge_gavel' },
  { speaker: 'DEFENSA', text: '«...cindad de la calle del Espanto 8, viv. 4.»', pose: 'chapulin_idle' },
