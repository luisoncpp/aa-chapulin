...
const CASE5_CLIMAX_STAGE5_SUCCESS_EN: ClimaxStage['successDialogue'] = [
  ...
  { speaker: 'BERRONDO', text: 'YOUR HONOR!', pose: 'berrondo_panic', bg: 'assets/bg_courtroom.webp' },
  { speaker: 'BERRONDO', text: 'That machine is estate property! Using it alters the deposit!', pose: 'berrondo_panic', bg: 'assets/bg_courtroom.webp' },
  ...
  { bg: 'assets/bg_gallery_characters.webp', furniture: 'none', speaker: 'NARRADOR', text: 'Eleven minutes. Nobody in the gallery moves.', bgm: 'suspense' },
  ...
  { bg: 'assets/bg_gallery_characters.webp', furniture: 'none', speaker: 'NARRADOR', text: 'The whole gallery rises.', sfx: 'realization', bgm: 'objection' },
