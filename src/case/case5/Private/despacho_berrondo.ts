...
export const CASE5_DESPACHO_BERRONDO: InvestigationScene = {
  ...
  intro: [
    ...
    { speaker: 'BERRONDO', text: 'Ayer, en la sala, se quedó usted mirando mi leontina durante cuarenta segundos.', pose: 'berrondo_idle' },
    { speaker: 'DEFENSA', text: '¿Leon... qué?', pose: 'chapulin_idle' },
    { speaker: 'BERRONDO', text: '...tina. Leontina. La cadena de oro que cruza el chaleco, del ojal al bolsillo del reloj.', pose: 'berrondo_definicion' },
    { speaker: 'DEFENSA', text: '¡Chanfle!', pose: 'chapulin_panic' },
    { speaker: 'BERRONDO', text: 'Un abogado que mira una leontina cuarenta segundos, viene.', pose: 'berrondo_idle' },
