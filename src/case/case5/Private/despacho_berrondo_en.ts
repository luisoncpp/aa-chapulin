...
export const CASE5_DESPACHO_BERRONDO_EN: InvestigationScene = {
  ...
  intro: [
    ...
    { speaker: 'BERRONDO', text: 'Yesterday in court you stared at my albert chain for forty seconds.', pose: 'berrondo_idle' },
    { speaker: 'DEFENSA', text: 'Your al... what?', pose: 'chapulin_idle' },
    { speaker: 'BERRONDO', text: '...bert. Albert chain. The gold watch chain that crosses the vest, from the buttonhole to the watch pocket.', pose: 'berrondo_definicion' },
    { speaker: 'DEFENSA', text: 'Chanfle!', pose: 'chapulin_panic' },
    { speaker: 'BERRONDO', text: 'A lawyer who stares at an albert chain for forty seconds is coming.', pose: 'berrondo_idle' },
