...
export const CASE5_BERRONDO_TALKS_EN: TalkOption[] = [
  {
    ...
    dialogue: [
      { speaker: 'BERRONDO', text: 'What remains of a dead corporation is called a bankruptcy estate.', pose: 'berrondo_definicion' },
      { speaker: 'DEFENSA', text: 'A bankrupt... what?', pose: 'chapulin_idle' },
      { speaker: 'BERRONDO', text: '...cy estate.', pose: 'berrondo_idle' },
  ...
  },
  {
    ...
    dialogue: [
      ...
      { speaker: 'NARRADOR', text: 'El Chapulín walks down the stairs at Donceles 14 and stops on the first landing.' },
