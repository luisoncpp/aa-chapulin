...
export const CASE5_FISCALIA_C5_HOTSPOTS: Hotspot[] = [
  {
    ...
    dialogue: [
      ...
      { speaker: 'SUPER SAM', text: 'Ésa es mi bolsa.', pose: 'supersam_idle' },
      ...
      { speaker: 'SUPER SAM', text: 'Lo sé perfectamente, counselor. Cerré ese caso en cinco minutos. Five.', pose: 'supersam_idle' },
