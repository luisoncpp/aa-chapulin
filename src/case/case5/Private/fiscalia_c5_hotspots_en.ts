...
export const CASE5_FISCALIA_C5_HOTSPOTS_EN: Hotspot[] = [
  {
    ...
    dialogue: [
      ...
      { speaker: 'SUPER SAM', text: 'That is my bag.', pose: 'supersam_idle' },
      ...
      { speaker: 'SUPER SAM', text: 'I know perfectly well, counselor. I closed that case in five minutes. Five.', pose: 'supersam_idle' },
