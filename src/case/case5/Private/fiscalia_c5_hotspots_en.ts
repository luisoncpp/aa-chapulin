// @Architecture(descriptionShort="English Case 5 day 3 prosecutor office canvas bag hotspot", type="data", icon="layers")
/**
...
export const CASE5_FISCALIA_C5_HOTSPOTS_EN: Hotspot[] = [
  {
    ...
    dialogue: [
      ...
      { speaker: 'DEFENSA', text: 'Then the one on your shoulder looks awfully full.', pose: 'chapulin_idle' },
      { speaker: 'SUPER SAM', text: 'Cotton, counselor.', pose: 'supersam_sweat' },
      ...
      { speaker: 'SUPER SAM', text: 'And I have been stuffing it with cotton for over three months so I do not forget why I closed it so fast.', pose: 'supersam_sweat' },
