...
export const CASE5_FISCALIA_C5_TALKS: TalkOption[] = [
  {
    ...
    dialogue: [
      { speaker: 'SUPER SAM', text: 'Oficio 4471, del veintiséis de noviembre. Mío, firmado por mí, ordenado por mí.', pose: 'supersam_idle' },
  ...
  },
  {
    ...
    dialogue: [
      ...
      { speaker: 'SUPER SAM', text: 'Era un preso ofreciendo un fichero a cambio de menos condena, counselor. Eso me llega todas las semanas.', pose: 'supersam_idle' },
      ...
      { speaker: 'SUPER SAM', text: 'Counselor. Vaya usted al penal y pida los efectos de ese hombre.', pose: 'supersam_idle' },
