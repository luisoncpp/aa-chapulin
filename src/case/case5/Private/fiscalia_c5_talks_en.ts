...
export const CASE5_FISCALIA_C5_TALKS_EN: TalkOption[] = [
  ...
  },
  {
    ...
    dialogue: [
      ...
      { speaker: 'SUPER SAM', text: 'It was an inmate offering a file for a shorter sentence, counselor. I get those every week.', pose: 'supersam_sweat' },
      ...
      { speaker: 'SUPER SAM', text: 'Counselor. Go to the penitentiary and ask for that man\'s effects.', pose: 'supersam_sweat' },
