...
export const CASE5_TRIAL_INTRO_FULL: DialogueLine[] = [
  ...
  { speaker: 'SUPER SAM', pose: 'supersam_point', text: 'Motive? El occiso iba a declarar el sábado que las cuatro victorias de este señor entre agosto y octubre no fueron talento. Fueron información comprada.' },
  ...
  { speaker: 'NARRADOR', text: 'La galería estalla. El Juez golpea el mazo tres veces.', sfx: 'gavel' },
