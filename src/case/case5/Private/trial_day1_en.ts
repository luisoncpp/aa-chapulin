...
export const CASE5_TRIAL_INTRO_FULL_EN: DialogueLine[] = [
  ...
  { speaker: 'SUPER SAM', pose: 'supersam_point', text: 'Motive? The deceased was going to testify Saturday that this gentleman\'s four victories between August and October were not talent. They were bought information.' },
  ...
  { speaker: 'NARRADOR', text: 'The gallery erupts. The Judge strikes the gavel three times.', sfx: 'gavel' },
