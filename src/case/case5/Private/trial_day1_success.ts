...
export const CASE5_D1_T2_TARJETA_SUCCESS: DialogueLine[] = [
  ...
  { speaker: 'NARRADOR', text: 'La galería se levanta.', sfx: 'gavel' },
...
export const CASE5_D1_T3_EXPEDIENTE_GIRO_SUCCESS: DialogueLine[] = [
  ...
  { speaker: 'NARRADOR', text: 'En la mesa de la fiscalía, el hombre de la leontina saca una pluma y anota una sola línea en una libreta.', bgm: 'suspense' },
