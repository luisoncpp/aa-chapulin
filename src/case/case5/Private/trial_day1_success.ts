...
export const CASE5_D1_T1_FORENSE_SUCCESS: DialogueLine[] = [
  ...
  { speaker: 'DEFENSA', text: 'Señor juez, el informe del legista fija la muerte entre las cinco y las cinco y media de la tarde.', pose: 'chapulin_point' },
...
export const CASE5_D1_T1_LIBRO_SUCCESS: DialogueLine[] = [
  { speaker: 'DEFENSA', text: '¡TOMA ESO! ¡El libro de visitas del público!', sfx: 'desk_slam', cutin: 'objection_toma_eso', pose: 'chapulin_slam' },
  ...
  { speaker: 'JUEZ', text: 'Testigo, puede retirarse por ahora. La corte quiere oír al agente que levantó la escena.', sfx: 'gavel', pose: 'judge_gavel' },
...
export const CASE5_D1_T2_PARTE_SUCCESS: DialogueLine[] = [
  { speaker: 'DEFENSA', text: '¡PROTESTO!', sfx: 'desk_slam', cutin: 'objection_protesto', pose: 'chapulin_slam', bgm: 'objection' },
  { speaker: 'DEFENSA', text: 'Señor juez, el anexo del parte de detención trae la hoja de relevo del Archivo, con cuatro firmas y cuatro horas.', pose: 'chapulin_point' },
  ...
  { speaker: 'DEFENSA', text: 'Por la escalera principal, que nace a tres metros del mostrador de un hombre que llevaba treinta y un años mirando esa puerta.', pose: 'chapulin_idle' },
...
export const CASE5_D1_T2_TARJETA_SUCCESS: DialogueLine[] = [
  ...
  { speaker: 'NARRADOR', text: 'La galería se levanta. El Juez golpea el mazo cuatro veces.', sfx: 'gavel' },
  ...
  { speaker: 'JUEZ', text: 'La corte necesita al conserje otra vez.', sfx: 'gavel', pose: 'judge_gavel' },
...
export const CASE5_D1_T3_EXPEDIENTE_GIRO_SUCCESS: DialogueLine[] = [
  ...
  { speaker: 'DEFENSA', text: 'Abierto en la foja doscientos catorce, señor juez. Y en la foja doscientos catorce hay una tarjeta pegada con engrudo.', pose: 'chapulin_idle' },
  ...
  { speaker: 'DEFENSA', text: 'Don Nicanor sacude el Tomo XI cada lunes. El sábado del crimen vio el estante completo y el expediente abierto en esta foja.', pose: 'chapulin_point' },
  { speaker: 'JUEZ', text: '¿Y qué venía a hacer ese hombre aquí con una tarjeta de once años de muerta?', pose: 'judge_thinking', updateProfile: 'perfil_casimiro' },
  ...
  { speaker: 'JUEZ', text: 'Ha lugar. Pero la corte la anota igual, porque la va a necesitar.', pose: 'judge_neutral' },
  ...
  { speaker: 'NARRADOR', text: 'En la mesa de la fiscalía, el hombre de la leontina saca una pluma y anota una sola línea en una libreta.' },
...
export const CASE5_D1_OPENING_BADGE_SUCCESS: DialogueLine[] = [
  ...
  { speaker: 'NARRADOR', text: 'En la mesa de la fiscalía, a la derecha de Super Sam, hay un segundo hombre. Traje negro de tres piezas y leontina de oro. No se ha movido.', addProfile: 'perfil_supersam' },
  ...
  { bg: PLATE_FOTO, furniture: 'none', speaker: 'NARRADOR', text: 'A un metro, un tomo encuadernado en tela con una mancha en el canto del lomo.' },
