...
export const CASE5_DAY2_INTRO_FULL: DialogueLine[] = [
  ...
  { speaker: 'SECRETARIO', pose: 'secretario_leyendo', text: 'Cuatro asientos, señor juez.' },
  { speaker: 'SECRETARIO', pose: 'secretario_leyendo_senala', text: 'Uno. Hermenegildo Rosas, perito valuador. Entrada nueve diez, gafete devuelto nueve cuarenta.' },
  { speaker: 'SECRETARIO', pose: 'secretario_leyendo_pagina', text: 'Dos. Licenciado Fulgencio Berrondo, síndico de la quiebra 114 diagonal 1971. Entrada dieciséis cero cinco, gafete devuelto dieciséis cincuenta.' },
  { speaker: 'SECRETARIO', pose: 'secretario_leyendo_mira', text: 'Tres. Licenciado Hilario Balbuena, actuario. Entrada diecisiete cuarenta y cuatro, gafete devuelto dieciocho cero cinco.' },
  { speaker: 'SECRETARIO', pose: 'secretario_leyendo', text: 'Cuatro. Sargento Refugio Pazguato, policía judicial. Entrada diecisiete cincuenta y dos, gafete devuelto veintidós quince.' },
  ...
  { speaker: 'BERRONDO', text: 'Es exacto, señor juez. Yo se lo dije al señor fiscal el lunes por la mañana, antes de la primera audiencia.', pose: 'berrondo_idle', bg: 'assets/bg_courtroom.webp' },
  { speaker: 'BERRONDO', text: 'Consideré que ocultarlo habría sido indigno y que declararlo sería útil. Me pareció que ambas cosas eran obvias.', pose: 'berrondo_idle', bg: 'assets/bg_courtroom.webp' },
