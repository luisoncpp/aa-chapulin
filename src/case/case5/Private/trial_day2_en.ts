...
export const CASE5_DAY2_INTRO_FULL_EN: DialogueLine[] = [
  ...
  { speaker: 'SECRETARIO', pose: 'secretario_leyendo', text: 'Four entries, Your Honor.' },
  { speaker: 'SECRETARIO', pose: 'secretario_leyendo_senala', text: 'One. Hermenegildo Rosas, valuation expert. Entry nine ten, badge returned nine forty.' },
  { speaker: 'SECRETARIO', pose: 'secretario_leyendo_pagina', text: 'Two. Counselor Fulgencio Berrondo, trustee in bankruptcy 114 diagonal 1971. Entry sixteen oh five, badge returned sixteen fifty.' },
  { speaker: 'SECRETARIO', pose: 'secretario_leyendo_mira', text: 'Three. Counselor Hilario Balbuena, court clerk. Entry seventeen forty-four, badge returned eighteen oh five.' },
  { speaker: 'SECRETARIO', pose: 'secretario_leyendo', text: 'Four. Sergeant Refugio Pazguato, judicial police. Entry seventeen fifty-two, badge returned twenty-two fifteen.' },
  ...
  { speaker: 'BERRONDO', text: 'That is exact, Your Honor. I told the prosecutor Monday morning, before the first hearing.', pose: 'berrondo_idle', bg: 'assets/bg_courtroom.webp' },
  { speaker: 'BERRONDO', text: 'I considered that hiding it would have been unworthy and that declaring it would be useful. Both seemed obvious to me.', pose: 'berrondo_idle', bg: 'assets/bg_courtroom.webp' },
