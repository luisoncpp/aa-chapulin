...
const EXPEDIENTE_POINT_SUCCESS: DialogueLine[] = [
...
export const POINT_EXPEDIENTE_SERIE: PointTargetContradiction = {
  ...
  successDialogue: EXPEDIENTE_POINT_SUCCESS
};
...
export const CASE5_D2_T1_RECIBO_SUCCESS: DialogueLine[] = [
  ...
  { speaker: 'BARRIGA', text: '¡Pues claro que lo asenté! ¡Yo seré casero, pero no soy mentiroso!', pose: 'barriga_reclamo' },
  { speaker: 'BARRIGA', text: 'Si el señor Ramón me hubiera pagado, yo hubiera escrito «recibí del señor Ramón», ¡y hubiera puesto un dibujito!', pose: 'barriga_sorpresa' },
  ...
  { speaker: 'BARRIGA', text: '...¿De veras?', pose: 'barriga_confundido' },
  { speaker: 'DEFENSA', text: 'De veras.', pose: 'chapulin_idle' },
  { speaker: 'BARRIGA', text: 'Uy. Entonces no me cobre la consulta.', pose: 'barriga_aliviado' },
  ...
  { speaker: 'NARRADOR', text: 'En la mesa de la fiscalía, el hombre de la cadena de oro se pone de pie.', bgm: 'suspense' },
  { speaker: 'BERRONDO', text: 'Señor juez. Con la venia de esta corte y el permiso del señor fiscal.', pose: 'berrondo_idle', bg: 'assets/bg_courtroom.webp' },
  { speaker: 'SUPER SAM', text: '¿Licenciado?', pose: 'supersam_sweat' },
  { speaker: 'BERRONDO', text: 'Llevo dos días oyendo a la defensa rodear mi nombre sin pronunciarlo, y eso es malo para todos: para ella, para la corte y para mí.', pose: 'berrondo_idle', bg: 'assets/bg_courtroom.webp' },
  { speaker: 'BERRONDO', text: 'Solicito rendir declaración voluntaria. Renuncio por este acto a mi carácter de coadyuvante mientras declare.', pose: 'berrondo_idle', bg: 'assets/bg_courtroom.webp' },
  { speaker: 'JUEZ', text: '¡Licenciado, nadie lo ha acusado de nada!', pose: 'judge_shock' },
  { speaker: 'BERRONDO', text: 'Todavía no, señor juez. Prefiero contestar antes que ser contestado.', pose: 'berrondo_idle', bg: 'assets/bg_courtroom.webp' },
...
export const CASE5_D2_T2_EXPEDIENTE_SUCCESS: DialogueLine[] = [
  ...
  { bg: 'assets/bg_gallery_characters.webp', furniture: 'none', speaker: 'NARRADOR', text: 'La sala entera se inclina hacia adelante.', sfx: 'realization', bgm: 'pursuit' },
  ...
  { bg: PLATE_CINCO, furniture: 'none', speaker: 'NARRADOR', text: 'Veintiuno de agosto. Un frasco de valeriana que compró el propio culpable de aquel robo, y el molde de cera que dejó al copiar una llave.' },
  { bg: PLATE_CINCO, furniture: 'none', speaker: 'NARRADOR', text: 'Veintiocho de agosto. Una ficha mecanografiada de seis renglones: la chapa, la rejilla, la ronda escrita del velador, y un servicio de cierre.' },
  { bg: PLATE_CINCO, furniture: 'none', speaker: 'NARRADOR', text: 'Quince de septiembre. Un gasto del culpable: doce mil pesos pagados para recuperar un micrófono.' },
  ...
  { bg: 'assets/bg_gallery_characters.webp', furniture: 'none', speaker: 'NARRADOR', text: 'La galería se levanta entera.', sfx: 'gavel' },
  ...
  { speaker: 'BERRONDO', text: 'Señor juez, agradezco esa precisión de la defensa más de lo que puedo decir.', pose: 'berrondo_idle', bg: 'assets/bg_courtroom.webp' },
  { speaker: 'BERRONDO', text: 'Y agrego tres cosas, numeradas, y me callo.', pose: 'berrondo_definicion', bg: 'assets/bg_courtroom.webp' },
  { speaker: 'BERRONDO', text: 'Primera. Todo lo que la defensa acaba de describir es lícito y yo lo he declarado antes de que ella lo descubriera.', pose: 'berrondo_idle', bg: 'assets/bg_courtroom.webp' },
  { speaker: 'BERRONDO', text: 'Segunda. No hay una sola prueba de que yo haya vendido la ficha del museo, y la defensa lo sabe.', pose: 'berrondo_idle', bg: 'assets/bg_courtroom.webp' },
  { speaker: 'BERRONDO', text: 'Tercera. Aunque la hubiera, vender información sigue sin ser delito en este país.', pose: 'berrondo_idle', bg: 'assets/bg_courtroom.webp' },
  { speaker: 'BERRONDO', text: 'Puede esta corte censurarme moralmente. No puede procesarme.', pose: 'berrondo_idle', bg: 'assets/bg_courtroom.webp' },
  ...
  { speaker: 'BERRONDO', text: 'Estaré ahí a las nueve menos cuarto, señor juez, con la llave y con el inventario.', pose: 'berrondo_idle', bg: 'assets/bg_courtroom.webp' },
  { speaker: 'BERRONDO', text: 'No tengo absolutamente nada que esconder.', pose: 'berrondo_idle', bg: 'assets/bg_courtroom.webp' },
...
export const CASE5_DAY2_OPENING_PRESENT_SUCCESS: DialogueLine[] = [
  ...
  { speaker: 'BARRIGA', text: 'Presente. Y quiero aclarar de una vez que yo no quería venir.', pose: 'barriga_reclamo' },
