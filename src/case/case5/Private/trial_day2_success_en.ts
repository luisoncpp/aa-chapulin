...
/** Plays on the correct panel click, before the parent follow-up success. */
const EXPEDIENTE_POINT_SUCCESS_EN: DialogueLine[] = [
...
export const POINT_EXPEDIENTE_SERIE_EN: PointTargetContradiction = {
  ...
  successDialogue: EXPEDIENTE_POINT_SUCCESS_EN
};
...
export const CASE5_D2_T1_NOTA_SUCCESS_EN: DialogueLine[] = [
  ...
  { speaker: 'BARRIGA', text: 'And with spelling mistakes.', pose: 'barriga_reclamo' },
  { bg: 'assets/bg_gallery_characters.webp', furniture: 'none', speaker: 'NARRADOR', text: 'Laughter in the gallery.', sfx: 'realization' },
...
export const CASE5_D2_T1_RECIBO_SUCCESS_EN: DialogueLine[] = [
  ...
  { speaker: 'BARRIGA', text: 'Of course I recorded it! I may be a landlord, but I am not a liar!', pose: 'barriga_reclamo' },
  { speaker: 'BARRIGA', text: 'If Mr. Ramon had paid me, I would have written "received from Mr. Ramon," and I would have drawn a little picture!', pose: 'barriga_sorpresa' },
  ...
  { speaker: 'BARRIGA', text: '...Really?', pose: 'barriga_confundido' },
  { speaker: 'DEFENSA', text: 'Really.', pose: 'chapulin_idle' },
  { speaker: 'BARRIGA', text: 'Oh. Then do not charge me for the consultation.', pose: 'barriga_aliviado' },
  ...
  { speaker: 'NARRADOR', text: 'At the prosecution table, the man with the watch chain stands up.', bgm: 'suspense' },
  { speaker: 'BERRONDO', text: 'Your Honor. With this court\'s leave and the prosecutor\'s permission.', pose: 'berrondo_idle', bg: 'assets/bg_courtroom.webp' },
  { speaker: 'SUPER SAM', text: 'Counselor?', pose: 'supersam_sweat' },
  { speaker: 'BERRONDO', text: 'I have spent two days hearing the defense circle my name without saying it, and that is bad for everyone: for her, for the court, and for me.', pose: 'berrondo_idle', bg: 'assets/bg_courtroom.webp' },
  { speaker: 'BERRONDO', text: 'I request to give voluntary testimony. By this act I waive my status as prosecution co-counsel while I testify.', pose: 'berrondo_idle', bg: 'assets/bg_courtroom.webp' },
  { speaker: 'JUEZ', text: 'Counselor, nobody has accused you of anything!', pose: 'judge_shock' },
  { speaker: 'BERRONDO', text: 'Not yet, Your Honor. I prefer to answer before I am answered.', pose: 'berrondo_idle', bg: 'assets/bg_courtroom.webp' },
...
/** Parent follow-up success: plays after the panel click (GIRO 2 through the gavel). */
export const CASE5_D2_T2_EXPEDIENTE_SUCCESS_EN: DialogueLine[] = [
  ...
  { bg: 'assets/bg_gallery_characters.webp', furniture: 'none', speaker: 'NARRADOR', text: 'The whole courtroom leans forward.', sfx: 'realization', bgm: 'pursuit' },
  ...
  { bg: PLATE_CINCO, furniture: 'none', speaker: 'NARRADOR', text: 'August 21. A bottle of valerian bought by the culprit of that robbery, and the wax mold he left behind copying a key.' },
  { bg: PLATE_CINCO, furniture: 'none', speaker: 'NARRADOR', text: 'August 28. A six-line typed card: the latch, the grate, the watchman\'s written round, and a closing service.' },
  { bg: PLATE_CINCO, furniture: 'none', speaker: 'NARRADOR', text: 'September 15. A spend by the culprit: twelve thousand pesos paid to recover a microphone.' },
  ...
  { bg: 'assets/bg_gallery_characters.webp', furniture: 'none', speaker: 'NARRADOR', text: 'The gallery rises as one.', sfx: 'gavel' },
  ...
  { speaker: 'BERRONDO', text: 'Your Honor, I appreciate that precision from the defense more than I can say.', pose: 'berrondo_idle', bg: 'assets/bg_courtroom.webp' },
  { speaker: 'BERRONDO', text: 'I will add three things, numbered, and then I will be quiet.', pose: 'berrondo_definicion', bg: 'assets/bg_courtroom.webp' },
  { speaker: 'BERRONDO', text: 'First. Everything the defense just described is lawful, and I declared it before she discovered it.', pose: 'berrondo_idle', bg: 'assets/bg_courtroom.webp' },
  { speaker: 'BERRONDO', text: 'Second. There is not a shred of proof that I sold the museum card, and the defense knows it.', pose: 'berrondo_idle', bg: 'assets/bg_courtroom.webp' },
  { speaker: 'BERRONDO', text: 'Third. Even if I had, selling information is still not a crime in this country.', pose: 'berrondo_idle', bg: 'assets/bg_courtroom.webp' },
  { speaker: 'BERRONDO', text: 'This court may censure me morally. It cannot prosecute me.', pose: 'berrondo_idle', bg: 'assets/bg_courtroom.webp' },
  ...
  { speaker: 'BERRONDO', text: 'I will be there at eight forty-five, Your Honor, with the key and the inventory.', pose: 'berrondo_idle', bg: 'assets/bg_courtroom.webp' },
  { speaker: 'BERRONDO', text: 'I have absolutely nothing to hide.', pose: 'berrondo_idle', bg: 'assets/bg_courtroom.webp' },
...
export const CASE5_DAY2_OPENING_PRESENT_SUCCESS_EN: DialogueLine[] = [
  ...
  { speaker: 'BARRIGA', text: 'Present. And let me clarify right now that I did not want to come.', pose: 'barriga_reclamo' },
