  ...
  statements: [
    {
      ...
      pressText: [
        ...
        { speaker: 'BARRIGA', text: 'It could. I do not sleep in the doorway, young man.', pose: 'barriga_reclamo' },
    ...
    },
    {
      ...
      pressText: [
        ...
        { speaker: 'BARRIGA', text: 'Brand-new. Hundreds, with the bank band still on two bundles.', pose: 'barriga_sorpresa' },
    ...
    },
    {
      ...
      speaker: 'BARRIGA',
      pose: 'barriga_idle',
      text: 'I made the receipt that same morning and gave it to Mr. Ramon that Monday, in the courtyard, in front of two neighbors.',
      pressText: [
        MOMENTO,
        { speaker: 'DEFENSA', text: 'What face did my client make when you gave him the receipt?', pose: 'chapulin_point' },
        { speaker: 'BARRIGA', text: 'A scared face.', pose: 'barriga_sorpresa' },
        { speaker: 'BARRIGA', text: 'I said "thank you, Mr. Ramon" and he said "thank you for what?" and stood there like a post.', pose: 'barriga_idle' },
    ...
    },
    {
      ...
      speaker: 'BARRIGA',
      pose: 'barriga_idle',
      text: 'I did not see anyone. But it had to be him. Who else would pay Mr. Ramon\'s rent?',
      pressText: [
        MOMENTO,
        { speaker: 'DEFENSA', text: 'Mr. Barriga, do you want Don Ramon convicted?', pose: 'chapulin_point' },
        { speaker: 'BARRIGA', text: 'Of course not!', pose: 'barriga_sorpresa' },
        { speaker: 'BARRIGA', text: 'If they lock him up, who do I charge? You do not collect rent from a prisoner.', pose: 'barriga_reclamo' },
