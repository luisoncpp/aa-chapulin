  ...
  statements: [
    ...
    },
    {
      ...
      pressText: [
        ...
        { speaker: 'JUEZ', text: '...Ha lugar, aunque a esta corte le habría gustado la respuesta.', pose: 'judge_thinking' },
    ...
    },
    {
      ...
      speaker: 'BERRONDO',
      pose: 'berrondo_idle',
      text: 'No conozco ni he conocido a ninguno de los sentenciados cuyos expedientes la defensa ha estado hojeando. Ni siquiera al occiso.',
      pressText: [
        MOMENTO,
        { speaker: 'DEFENSA', text: '¿Ni al occiso? ¡Fue distribuidor de su propia empresa!', pose: 'chapulin_point' },
