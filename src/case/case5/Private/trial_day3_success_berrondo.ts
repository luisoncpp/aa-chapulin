...
export const CASE5_D3_T3_ACUSE_SUCCESS: DialogueLine[] = [
  ...
  { speaker: 'DEFENSA', text: '«Oficio 4471. Diligencia de cotejo documental promovida por el interno C. Lengua». Archivo Judicial, cuatro de diciembre, 17:00.', pose: 'chapulin_idle' },
  { speaker: 'DEFENSA', text: '«Entregado en: Sindicatura de la quiebra 114/71.»', pose: 'chapulin_idle' },
  { speaker: 'DEFENSA', text: 'Y al margen, señor juez, una rúbrica.', pose: 'chapulin_slam', sfx: 'desk_slam' },
  { bg: 'assets/bg_gallery_characters.webp', furniture: 'none', speaker: 'NARRADOR', text: 'La sala entera se vuelve hacia el estrado.', sfx: 'realization' },
...
const CASE5_DAY3_GIRO3: DialogueLine[] = [
  ...
  { speaker: 'JUEZ', text: 'El perito fija la muerte entre las 17:00 y las 17:30.', pose: 'judge_neutral' },
  { speaker: 'JUEZ', text: 'El acusado firmó su salida a las 16:58.', pose: 'judge_neutral' },
  { speaker: 'JUEZ', text: 'Y el licenciado Berrondo devolvió su gafete a las 16:50.', pose: 'judge_thinking' },
  ...
  { bg: 'assets/bg_gallery_characters.webp', furniture: 'none', speaker: 'NARRADOR', text: 'La sala se vacía despacio. Super Sam sale sin la bolsa de lona, que se queda sobre la mesa.' },
...
export const CASE5_D3_T3_TOMO_SUCCESS: DialogueLine[] = [
  ...
  { speaker: 'DEFENSA', text: '«Donación del síndico de la quiebra 114/71. Catorce de octubre de mil novecientos setenta y uno.»', pose: 'chapulin_slam', sfx: 'desk_slam' },
