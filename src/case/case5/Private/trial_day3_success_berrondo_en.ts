...
const CASE5_DAY3_GIRO3_EN: DialogueLine[] = [
  ...
  { speaker: 'JUEZ', text: 'Counselor Chapulín: you showed this court that building had a second door.', pose: 'judge_neutral' },
  ...
  { speaker: 'JUEZ', text: 'I know, Counselor Valdés. And this court cannot sentence on what it knows: it sentences on what is proved.', pose: 'judge_neutral' },
