...
export const CASE5_D3_T3_ACUSE_SUCCESS_EN: DialogueLine[] = [
  ...
  { speaker: 'DEFENSA', text: '"Delivered to: Syndicate for bankruptcy 114/71."', pose: 'chapulin_idle' },
  { speaker: 'DEFENSA', text: 'And in the margin, Your Honor, a rubric.', pose: 'chapulin_slam', sfx: 'desk_slam' },
  { bg: 'assets/bg_gallery_characters.webp', furniture: 'none', speaker: 'NARRADOR', text: 'The whole room turns toward the stand.', sfx: 'realization' },
...
const CASE5_DAY3_GIRO3_EN: DialogueLine[] = [
  ...
  { bg: 'assets/bg_gallery_characters.webp', furniture: 'none', speaker: 'NARRADOR', text: 'The room empties slowly. Super Sam leaves without the canvas bag, which stays on the table.' },
...
export const CASE5_D3_T3_TOMO_SUCCESS_EN: DialogueLine[] = [
  ...
  { speaker: 'DEFENSA', text: '"Donation from the syndic of bankruptcy 114/71. October 14, 1971."', pose: 'chapulin_slam', sfx: 'desk_slam' },
  { bg: 'assets/bg_gallery_characters.webp', furniture: 'none', speaker: 'NARRADOR', text: 'Long murmur in the gallery.', sfx: 'realization' },
