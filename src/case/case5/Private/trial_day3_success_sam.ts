...
export const CASE5_D3_T2_OFICIO_SUCCESS: DialogueLine[] = [
  ...
  { speaker: 'DEFENSA', text: 'Lo pone la ley, señor fiscal. Nadie toca las cosas de una quiebra sin avisarle al síndico que las cuida.', pose: 'chapulin_point' },
  { speaker: 'DEFENSA', text: 'Y eso quiere decir que hubo una sexta persona, señor juez. Una oficina entera que el señor fiscal no contó.', pose: 'chapulin_point' },
...
export const CASE5_D3_T2_EXPEDIENTE_SUCCESS: DialogueLine[] = [
  ...
  { speaker: 'SUPER SAM', text: '...Ése es mi sobre.', pose: 'supersam_sweat' },
  { speaker: 'JUEZ', text: '¿Cómo que su sobre?', pose: 'judge_shock' },
  { speaker: 'SUPER SAM', text: 'El tercer renglón del sobre que me metieron por debajo de la puerta decía eso, Your Honor. Con esas palabras.', pose: 'supersam_sweat' },
  { speaker: 'DEFENSA', text: 'Y usted cerró ese caso en cinco minutos, señor fiscal. Lo dijo usted mismo, en esta sala, en agosto.', pose: 'chapulin_idle' },
  { speaker: 'DEFENSA', text: '«Five.» Gritado con un manotazo.', pose: 'chapulin_idle' },
