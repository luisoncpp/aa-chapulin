...
export const CASE5_D3_T2_OFICIO_SUCCESS_EN: DialogueLine[] = [
  ...
  { speaker: 'DEFENSA', text: 'And at the foot is the distribution list, printed on his own office machine.', pose: 'chapulin_idle' },
  ...
  { speaker: 'DEFENSA', text: 'The law puts it in, Mr. Prosecutor. Estate goods cannot be touched without notifying the syndic.', pose: 'chapulin_point' },
  ...
  { speaker: 'SUPER SAM', text: 'That I sign six hundred letters a month, Your Honor, and I have not read the foot of one in eleven years.', pose: 'supersam_sweat' },
  { speaker: 'JUEZ', text: 'So entered.', sfx: 'gavel', pose: 'judge_gavel', updateProfile: 'perfil_supersam' },
  { speaker: 'JUEZ', text: 'And let it also be entered that this court still has nothing against anyone, because receiving a legal notice is not a crime.', pose: 'judge_neutral', updateProfile: 'perfil_casimiro' },
...
export const CASE5_D3_T2_EXPEDIENTE_SUCCESS_EN: DialogueLine[] = [
  ...
  { speaker: 'DEFENSA', text: 'Panel B, Your Honor. The card found in the museum loading yard on August 21. Six lines.', pose: 'chapulin_point' },
  { speaker: 'JUEZ', text: 'Read them.', sfx: 'gavel', bgm: 'suspense', pose: 'judge_gavel' },
  { speaker: 'DEFENSA', text: '"One. Loading-door latch: expired since March. Push to open."', pose: 'chapulin_idle' },
  { speaker: 'DEFENSA', text: '"Two. Hall two grate: eighteen by twenty-four."', pose: 'chapulin_idle' },
  { speaker: 'DEFENSA', text: '"Three. Watchman\'s round: twenty forty-five fore hold; twenty-one hundred aft hold. Copied from his notebook."', pose: 'chapulin_idle' },
  { speaker: 'DEFENSA', text: '"Four. Pills: Insurgentes pharmacy, back counter."', pose: 'chapulin_idle' },
  { speaker: 'DEFENSA', text: '"Five. Camera roll: changed Mondays. Tuesday leaves one frame."', pose: 'chapulin_idle' },
  { speaker: 'DEFENSA', text: 'And six.', pose: 'chapulin_point' },
  { speaker: 'DEFENSA', text: '"Closing service included. Five minutes."', pose: 'chapulin_slam', sfx: 'desk_slam' },
  { speaker: 'NARRADOR', text: 'Super Sam stares at that line.', bgm: 'suspense' },
  { speaker: 'SUPER SAM', text: '...Five minutes?', pose: 'supersam_sweat' },
  { speaker: 'DEFENSA', text: 'You closed that case in five minutes, Mr. Prosecutor. You said so yourself, in this room, in August.', pose: 'chapulin_idle' },
  { speaker: 'DEFENSA', text: '"Five." With your hand raised.', pose: 'chapulin_idle' },
