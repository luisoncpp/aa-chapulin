...
export const CASE5_TESTIMONY_7_EN: Testimony = {
  ...
  statements: [
    ...
    },
    {
      ...
      speaker: 'SUPER SAM',
      pose: 'supersam_idle',
      text: 'It was once. It had no name, no receipt, and I did not sell it to anyone. An envelope under my door and a bundle in an alley.',
      pressText: [
        MOMENTO,
        { speaker: 'DEFENSA', text: 'How much was in that bundle?', pose: 'chapulin_point' },
        { speaker: 'SUPER SAM', text: 'One kilo. Ten thousand pesos in silver coin.', pose: 'supersam_idle' },
        { speaker: 'DEFENSA', text: 'And who left it?', pose: 'chapulin_idle' },
        { speaker: 'SUPER SAM', text: 'I do not know. It was in the alley the envelope named, at the hour the envelope named, wrapped in butcher paper like a kilo of meat.', pose: 'supersam_sweat' },
        ...
        { speaker: 'DEFENSA', text: 'And how did the count come out?', pose: 'chapulin_idle' },
        { speaker: 'SUPER SAM', text: 'That morning someone had entered my chambers and taken my bag. Six kilos.', pose: 'supersam_sweat' },
        { speaker: 'JUEZ', text: 'Six?', pose: 'judge_thinking' },
        { speaker: 'SUPER SAM', text: 'Six, Your Honor. I carried it on my shoulder for eleven years. I know what it weighs.', pose: 'supersam_sweat' },
        { speaker: 'DEFENSA', text: 'So that night, in that alley, what they handed you...', pose: 'chapulin_point' },
        { speaker: 'SUPER SAM', text: 'Was my own silver, counselor. They gave me back one kilo out of six and I said yes.', pose: 'supersam_sweat' },
        { speaker: 'DON RAMÓN', text: '(Do not finish him off, son.)', pose: 'donramon_idle' },
        { speaker: 'DEFENSA', text: 'And you never reported the burglary?', pose: 'chapulin_idle' },
        { speaker: 'SUPER SAM', text: 'I was going to file it at noon. By five in the afternoon I was bought, and a bought man has nothing left to report.', pose: 'supersam_sweat' },
        { speaker: 'DEFENSA', text: 'Mr. Prosecutor. That night an empty canvas bag bearing your office seal was left in that museum\'s loading yard.', pose: 'chapulin_point' },
        ...
        { speaker: 'SUPER SAM', text: 'The hour and the address. And below them a line that asked me for nothing.', pose: 'supersam_idle' },
        { speaker: 'DEFENSA', text: 'What do you mean, it asked for nothing?', pose: 'chapulin_idle' },
        { speaker: 'SUPER SAM', text: 'It was written the way you write what has already been sold. It did not say "do this". It said what came included.', pose: 'supersam_sweat' },
