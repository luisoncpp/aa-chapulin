  ...
  statements: [
    ...
    },
    {
      ...
      pressText: [
        ...
        { speaker: 'BERRONDO', text: 'Climb the service stair and walk to the wicket. That is forty steps, counselor, and I am seventy-one.', pose: 'berrondo_idle' },
        { speaker: 'DEFENSA', text: '(Ten minutes for forty steps. That is reasonable. So reasonable it is infuriating.)', pose: 'chapulin_idle' }
      ]
    },
    {
      id: 'c5_d3t3_4',
