...
export const CASE5_VECINDAD_EN: InvestigationScene = {
  ...
  intro: [
    { speaker: 'NARRADOR', text: 'December 7, 8:30 AM. Mr. Barriga\'s office in the tenement on Spook Street.', bg: 'assets/bg_despacho_c5.webp', furniture: 'none', bgm: 'investigation' },
    { speaker: 'BARRIGA', text: 'Oh, no! Not again! I already know why you are here!', pose: 'barriga_reclamo' },
    { speaker: 'DEFENSA', text: 'I have not told you anything.', pose: 'chapulin_idle' },
    { speaker: 'BARRIGA', text: 'Because every time someone from this tenement knocks it is to ask for an extension!', pose: 'barriga_reclamo' },
    ...
    { speaker: 'BARRIGA', text: 'That.', pose: 'barriga_sorpresa' },
    { speaker: 'BARRIGA', text: 'Look, young man. I have been collecting from Mr. Ramon for seventeen years. Seventeen.', pose: 'barriga_idle' },
    { speaker: 'BARRIGA', text: 'And on November twenty-ninth I found a yellow envelope under my door with seventeen months inside.', pose: 'barriga_sorpresa' },
    ...
    { speaker: 'BARRIGA', text: 'From shock. When something fixes itself after seventeen years, you know something broke somewhere else.', pose: 'barriga_confundido', addProfile: 'perfil_barriga' }
  ],
