...
export const CASE5_VECINDAD_HOTSPOTS_EN: Hotspot[] = [
  ...
  },
  {
    ...
    dialogue: [
      ...
      { speaker: 'DEFENSA', text: '"Enclosed is payment for seventeen overdue months charged to C. Ramón Valdés, tenant of dwelling 4."', pose: 'chapulin_idle' },
      { speaker: 'DEFENSA', text: '"Please issue the corresponding receipt and retain it. No reply required."', pose: 'chapulin_point' },
      { speaker: 'DEFENSA', text: '...Mr. Barriga, do you think Don Ramón writes like this?', pose: 'chapulin_idle' },
      { speaker: 'BARRIGA', text: 'Young man, Mr. Ramón sends me notes scribbled on a cake wrapper.', pose: 'barriga_idle' },
