...
export const CASE5_VECINDAD_TALKS: TalkOption[] = [
  ...
  },
  {
    ...
    dialogue: [
      ...
      { speaker: 'BARRIGA', text: 'Lo hice esa misma mañana y se lo di al señor Ramón el lunes en el patio. Le dije «gracias» y él puso una cara rarísima.', pose: 'barriga_shock' },
      ...
      { speaker: 'BARRIGA', text: 'Porque no me lo dio él, joven. Yo seré casero, pero no soy mentiroso.', pose: 'barriga_enojado' },
  ...
  },
  {
    ...
    dialogue: [
      ...
      { speaker: 'BARRIGA', text: 'Joven, yo no quiero que metan al señor Ramón a la cárcel. Me debe diecisiete meses.', pose: 'barriga_shock' },
      { speaker: 'BARRIGA', text: '...Me DEBÍA. Ay, ya ni sé.', pose: 'barriga_enojado' },
      ...
      { speaker: 'BARRIGA', text: 'Dos pesos la copia.', pose: 'barriga_enojado' },
