...
export const CASE5_VECINDAD_TALKS_EN: TalkOption[] = [
  ...
  },
  {
    ...
    dialogue: [
      ...
      { speaker: 'BARRIGA', text: 'I wrote it that same morning and gave it to Mr. Ramon on Monday in the courtyard. I said "thank you" and he made a very strange face.', pose: 'barriga_sorpresa' },
      ...
      { speaker: 'BARRIGA', text: 'Because he did not give it to me, young man. I may be a landlord, but I am not a liar.', pose: 'barriga_reclamo' },
  ...
  },
  {
    ...
    dialogue: [
      ...
      { speaker: 'BARRIGA', text: 'Young man, I do not want Mr. Ramon sent to prison. He owes me seventeen months.', pose: 'barriga_sorpresa' },
      { speaker: 'BARRIGA', text: '...He OWED me. Oh, I do not even know anymore.', pose: 'barriga_confundido' },
      ...
      { speaker: 'BARRIGA', text: 'Two pesos a copy.', pose: 'barriga_reclamo' },
