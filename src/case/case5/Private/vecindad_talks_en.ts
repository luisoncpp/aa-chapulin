...
export const CASE5_VECINDAD_TALKS_EN: TalkOption[] = [
  ...
  },
  {
    ...
    dialogue: [
      ...
      { speaker: 'BARRIGA', text: 'I wrote it that same morning and gave it to Mr. Ramón on Monday in the courtyard. I said "thank you" and he made a very strange face.', pose: 'barriga_shock' },
      ...
      { speaker: 'DEFENSA', text: 'Why did you not put Don Ramón\'s name?', pose: 'chapulin_idle' },
      ...
      { speaker: 'DEFENSA', text: '(This man just wrote, without meaning to, the defense\'s best proof. And he is going to take the stand and say it was Don Ramón.)', pose: 'chapulin_idle' }
    ]
  },
  {
    id: 'porque_donramon',
    label: 'Why do you think it was Don Ramón?',
    unlockedByTalk: 'que_hizo_dinero',
    dialogue: [
      { speaker: 'BARRIGA', text: 'Who else was going to pay Mr. Ramón\'s rent?', pose: 'barriga_idle' },
      { speaker: 'DEFENSA', text: 'I do not know. That is what I came to find out.', pose: 'chapulin_idle' },
      { speaker: 'BARRIGA', text: 'Young man, I do not want Mr. Ramón sent to prison. He owes me seventeen months.', pose: 'barriga_shock' },
