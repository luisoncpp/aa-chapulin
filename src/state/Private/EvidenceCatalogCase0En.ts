...
export const CASE0_EVIDENCE_EN: Record<string, EvidenceItem> = {
  ...
  parte_detencion: ev('parte_detencion', 'Arrest Report', 'July 12 report: arrest at 2:15 PM. The detainee arrived carrying an enormous ice bar, both hands occupied. Inventory: that ice bar, 40 cents, and ice-shop receipt. House 4 lock broken since March. Collection file not found. Annex: Lengua’s 2:15 description of the file.', ['Updated report: the witness described the file’s color and clasp and stated it was carried in the left hand at 2:15, while the detainee carried the ice bar with both hands.']),
