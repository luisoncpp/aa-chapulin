...
export const CASE3_EVIDENCE_ES: Record<string, EvidenceItem> = {
  informe_medico: ev('informe_medico', {
  ...
  microfono_oro: ev('microfono_oro', {
    ...
    desc: 'Trofeo de bronce macizo de 4 kg con base octagonal. Hallado sobre la mesa de la consola. Arma del delito.',
    updates: [
  ...
  marcas_carrito: ev('marcas_carrito', {
    ...
    desc: 'Dos rayas paralelas de grasa negra en la alfombra del pasillo, del despacho a la Cabina B. En una rueda quedó atorado un hilo del saco del Señor Barriga.'
  }),
  ventana_cabina: ev('ventana_cabina', {
    name: 'Cuña de la Ventana',
    desc: 'Cuña de madera y nota de mantenimiento: el ventilador central lleva descompuesto desde agosto, así que las tres cabinas graban con la ventana abierta.'
  }),
  ...
  bitacora_transmision: ev('bitacora_transmision', {
    ...
    desc: 'Registro de la noche. 23:03 — CORTE DE ESTACIÓN (CARTUCHO 3) — AUTOMÁTICO. Además: 21:30-21:50 Cabina B y 21:30-22:00 Cabina A.'
  }),
  receta_nono: ev('receta_nono', {
    name: 'Libreta de Consultas de la Clínica',
    desc: 'Asiento del 15 de septiembre, 10:50 PM: aplicación de cardiotónico a un paciente registrado sólo con iniciales. Escrito de puño y letra del acusado.'
  }),
  ...
  ataduras_bodega: ev('ataduras_bodega', {
    ...
    desc: 'El pañuelo de seda y el cable de micrófono que ataron a Aniceto. El nudo de la mordaza quedó al frente, del lado izquierdo; las muñecas no tienen marca alguna.'
  }),
  cartucho_corte: ev('cartucho_corte', {
    name: 'Cartucho de Corte de Estación',
    desc: 'Cartucho rotulado "IDENTIFICACIÓN XEVC", rescatado de la basura por el Sargento Pazguato.',
    updates: [
  ...
  cinta_sketch: ev('cinta_sketch', {
    ...
    desc: 'Sketch semanal de XEVC: un personaje que imita la voz del Señor Barriga y cierra siempre con "¡Tenía que ser el Chavo del Ocho!".'
  }),
...
export const CASE3_EVIDENCE_EN: Record<string, EvidenceItem> = {
  ...
  microfono_oro: ev('microfono_oro', {
    ...
    desc: '4 kg solid bronze trophy with octagonal base. Found on the console table. Murder weapon.',
    updates: [
  ...
  marcas_carrito: ev('marcas_carrito', {
    ...
    desc: 'Two parallel black grease lines on the hallway carpet from the office to Cabin B. A thread from Barriga\'s coat stuck in a wheel.'
  }),
  ventana_cabina: ev('ventana_cabina', {
    name: 'Window Wedge',
    desc: 'Wooden wedge and maintenance note: central fan broken since August, so all three cabins record with the window open.'
  }),
  libro_verde: ev('libro_verde', {
    name: 'Green Ledger',
  ...
  bitacora_transmision: ev('bitacora_transmision', {
    ...
    desc: 'Night log. 23:03 — STATION ID (CARTRIDGE 3) — AUTOMATIC. Plus: 21:30-21:50 Cabin B and 21:30-22:00 Cabin A.'
  }),
  receta_nono: ev('receta_nono', {
    name: 'Clinic Appointment Book',
    desc: 'September 15, 10:50 PM entry: cardiotonic applied to a patient logged only by initials. In the defendant\'s handwriting.'
  }),
  programa_kermes: ev('programa_kermes', {
    name: 'Kermés Program',
  ...
  ataduras_bodega: ev('ataduras_bodega', {
    ...
    desc: 'Silk handkerchief and microphone cable used on Aniceto. Gag knot tied in front on the left; wrists show no marks.'
  }),
  cartucho_corte: ev('cartucho_corte', {
    name: 'Station ID Cartridge',
    desc: 'Cartridge labeled "XEVC IDENTIFICATION", rescued from trash by Sergeant Pazguato.',
    updates: [
  ...
  cinta_sketch: ev('cinta_sketch', {
    ...
    desc: 'Weekly XEVC sketch: a character imitating Barriga\'s voice, always ending with "It had to be El Chavo del Ocho!"'
  }),
  boleta_empeno: ev('boleta_empeno', {
    name: 'Pawn Ticket',
