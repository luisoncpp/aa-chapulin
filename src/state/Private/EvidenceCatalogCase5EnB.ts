...
export const CASE5_EVIDENCE_EN_B: Record<string, EvidenceItem> = {
  ...
  oficio_diligencia: ev('oficio_diligencia', {
    ...
    desc: 'Prosecution official letter 4471, November 26: orders the diligence set for Saturday, December 4 at 5:00 PM at the Judicial Archive, appoints court clerk Hilario Balbuena, and summons Ramón Valdés at Casimiro\'s request. The distribution list names the assigned clerk, the Archive Directorate, and the bankruptcy syndic 114/1971.'
  }),
